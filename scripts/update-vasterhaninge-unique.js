...
const svDataPath = path.join(__dirname, 'data', 'vasterhaninge-sv.json');
const enDataPath = path.join(__dirname, 'data', 'vasterhaninge-en.json');
...
saveLocale(svPath, 'vasterhaninge', svContent);
saveLocale(enPath, 'vasterhaninge', enContent);
