...
const svDataPath = path.join(__dirname, 'data', 'upplandsvasby-sv.json');
const enDataPath = path.join(__dirname, 'data', 'upplandsvasby-en.json');
...
saveLocale(svPath, 'upplandsvasby', svContent);
saveLocale(enPath, 'upplandsvasby', enContent);
