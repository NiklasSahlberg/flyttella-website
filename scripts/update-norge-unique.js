...
const svDataPath = path.join(__dirname, 'data', 'norge-sv.json');
const enDataPath = path.join(__dirname, 'data', 'norge-en.json');
...
saveLocale(svPath, 'norge', svContent);
saveLocale(enPath, 'norge', enContent);

console.log('Norge-texter uppdaterade i sv/en.');
