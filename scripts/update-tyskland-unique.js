...
const svDataPath = path.join(__dirname, 'data', 'tyskland-sv.json');
const enDataPath = path.join(__dirname, 'data', 'tyskland-en.json');
...
saveLocale(svPath, 'tyskland', svContent);
saveLocale(enPath, 'tyskland', enContent);

console.log('Tyskland-texter uppdaterade i sv/en.');
