...
const svDataPath = path.join(__dirname, 'data', 'vasastan-sv.json');
const enDataPath = path.join(__dirname, 'data', 'vasastan-en.json');
...
saveLocale(svPath, 'vasastan', svContent);
saveLocale(enPath, 'vasastan', enContent);

console.log('Vasastan-texter uppdaterade i sv/en.');
