...
const svDataPath = path.join(__dirname, 'data', 'varmdo-sv.json');
const enDataPath = path.join(__dirname, 'data', 'varmdo-en.json');
...
saveLocale(svPath, 'varmdo', svContent);
saveLocale(enPath, 'varmdo', enContent);
