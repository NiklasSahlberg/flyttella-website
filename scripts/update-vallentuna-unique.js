...
const svDataPath = path.join(__dirname, 'data', 'vallentuna-sv.json');
const enDataPath = path.join(__dirname, 'data', 'vallentuna-en.json');
...
saveLocale(svPath, 'vallentuna', svContent);
saveLocale(enPath, 'vallentuna', enContent);
