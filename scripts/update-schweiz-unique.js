...
const svDataPath = path.join(__dirname, 'data', 'schweiz-sv.json');
const enDataPath = path.join(__dirname, 'data', 'schweiz-en.json');
...
saveLocale(svPath, 'schweiz', svContent);
saveLocale(enPath, 'schweiz', enContent);

console.log('Schweiz-texter uppdaterade i sv/en.');
