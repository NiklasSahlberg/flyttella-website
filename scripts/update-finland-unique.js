...
const svDataPath = path.join(__dirname, 'data', 'finland-sv.json');
const enDataPath = path.join(__dirname, 'data', 'finland-en.json');
...
saveLocale(svPath, 'finland', svContent);
saveLocale(enPath, 'finland', enContent);

console.log('Finland-texter uppdaterade i sv/en.');
