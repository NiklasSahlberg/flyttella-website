// Update Kista content to be much more unique with new FAQ questions
const fs = require('fs');
...
const svContent = {
  ...
  about: {
    ...
    desktop: 'Sedan 2016 har vi etablerat oss som Kistas mest betrodda flyttpartner – vi hjälper kunder i Akalla, Husby och Tensta med professionella flyttlösningar. Vår passion för kvalitet och djup lokalkännedom gör oss till den perfekta valet för Kistas invånare.',
    desktop2: 'Mer än 8 000 framgångsrika flyttar har gjort oss till en betrodd partner för både privatpersoner och företag i Kista. Vår transparenta prissättning och tydliga kommunikation gör att du alltid vet vad som ingår. Varje flytt skräddarsys efter Kistas unika karaktär – från IT-företagens kontor till moderna bostadsområden med sina specifika regler och förutsättningar.',
...
const enContent = {
  ...
  about: {
    ...
    desktop: 'Since 2016 we have established ourselves as Kista\'s most trusted moving partner – we help clients in Akalla, Husby and Tensta with professional moving solutions. Our passion for quality and deep local knowledge makes us the perfect choice for Kista residents.',
    desktop2: 'More than 8,000 successful moves have made us a trusted partner for both individuals and businesses in Kista. Our transparent pricing and clear communication means you always know what\'s included. Every move is tailored to Kista\'s unique character – from IT companies\' offices to modern residential areas with their specific rules and conditions.',
    desktop3: 'Our competitive advantages include free moving boxes, flexible rebooking up to 24 hours before move day and a generous 14-day cleaning guarantee. Our dedicated customer service follows the entire moving process and ensures every detail is perfectly planned for Kista\'s specific conditions.',
...
console.log('Updated Kista content to be much more unique with new FAQ questions.');
