...
const svDataPath = path.join(__dirname, 'data', 'taby-sv.json');
const enDataPath = path.join(__dirname, 'data', 'taby-en.json');
...
saveLocale(svPath, 'taby', svContent);
saveLocale(enPath, 'taby', enContent);
