...
const svDataPath = path.join(__dirname, 'data', 'italien-sv.json');
const enDataPath = path.join(__dirname, 'data', 'italien-en.json');
...
saveLocale(svPath, 'italien', svContent);
saveLocale(enPath, 'italien', enContent);

console.log('Italien-texter uppdaterade i sv/en.');
