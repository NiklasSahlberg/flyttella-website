...
const svDataPath = path.join(__dirname, 'data', 'danmark-sv.json');
const enDataPath = path.join(__dirname, 'data', 'danmark-en.json');
...
saveLocale(svPath, 'danmark', svContent);
saveLocale(enPath, 'danmark', enContent);

console.log('Danmark-texter uppdaterade i sv/en.');
