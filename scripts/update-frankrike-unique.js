...
const svDataPath = path.join(__dirname, 'data', 'frankrike-sv.json');
const enDataPath = path.join(__dirname, 'data', 'frankrike-en.json');
...
saveLocale(svPath, 'frankrike', svContent);
saveLocale(enPath, 'frankrike', enContent);

console.log('Frankrike-texter uppdaterade i sv/en.');
