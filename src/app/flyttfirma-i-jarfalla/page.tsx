...
export const metadata: Metadata = {
  title: 'Flyttfirma i Järfälla | Professionell Flyttservice | Flyttella',
  description: 'Professionell flyttfirma i Järfälla. Vi erbjuder flyttstädning, packning och bohagsflytt i Järfälla och omnejd. Erfarenhet sedan 2010.',
  keywords: 'flyttfirma järfälla, flyttstädning järfälla, packning järfälla, bohagsflytt järfälla, flyttfirma stockholm',
  openGraph: {
    title: 'Flyttfirma i Järfälla | Professionell Flyttservice | Flyttella',
    description: 'Professionell flyttfirma i Järfälla. Vi erbjuder flyttstädning, packning och bohagsflytt i Järfälla och omnejd.',
    type: 'website',
    locale: 'sv_SE',
  },
};
          ...
          <div className="max-w-4xl mx-auto">
            <div className="text-center mb-12">
              <h1 className="text-4xl md:text-6xl font-bold mb-6">
                Flyttfirma i Järfälla
              </h1>
              <p className="text-xl md:text-2xl text-white/90 mb-8">
                Professionell flyttservice i Järfälla - från Jakobsberg och Barkarby till Stäket och Kallhäll. Vi förstår de unika utmaningarna med att flytta i Järfällas växande kommun.
              </p>
            </div>
      ...
      <div className="container mx-auto px-4 py-16">
        ...
        <div className="max-w-4xl mx-auto mb-16">
          <div className="bg-white rounded-xl shadow-lg p-8 md:p-12">
            <h2 className="text-2xl md:text-3xl font-bold text-[#0F172A] mb-6">
              Professionell flyttservice i Järfälla
            </h2>
            <div className="space-y-4 text-gray-600">
              <p className="text-lg">
                Som ledande flyttfirma i Järfälla har vi specialiserat oss på att hantera alla typer av flyttar - från lägenheter till villor i hela kommunen. 
                Med vår erfarenhet sedan 2010 har vi hjälpt tusentals kunder med deras flyttar i Järfälla och omnejd.
              </p>
              <p className="text-lg">
                Vi förstår de särskilda utmaningarna med att flytta i Järfälla - från hantering av flyttar i höghus till effektiv packning av villor. 
                Vår expertis och lokalkännedom säkerställer en smidig flyttprocess för alla typer av bostäder i hela kommunen.
              </p>
            </div>
          </div>
        </div>
          ...
          <div className="bg-white rounded-lg shadow-lg p-8">
            ...
            <ul className="space-y-3">
              {[
                ...
                "Hantering av både höghus och villor",
                "Fullständig försäkring",
                "Flexibla tider",
                "Lokal expertis i hela Järfälla",
          ...
          <div className="bg-white rounded-lg shadow-lg p-8">
            ...
            <ul className="space-y-3">
              {[
                ...
                "Städgaranti",
                "Flexibla tider",
                "Erfaren personal i Järfälla",
                "Snabb service i hela kommunen"
              ].map((item, index) => (
                <li key={index} className="flex items-start">
                  <svg className="w-5 h-5 text-[#10B981] mt-1 mr-3 flex-shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" />
        ...
        <div className="text-center">
          <h2 className="text-3xl font-bold text-[#0F172A] mb-6">
            Boka din flytt i Järfälla idag
          </h2>
          <p className="text-lg text-gray-600 mb-8 max-w-2xl mx-auto">
            Vi erbjuder skräddarsydda lösningar för alla typer av flyttar i hela Järfälla - från Jakobsbergs höghus till Barkarbys moderna bostäder, från Stäkets villaområden till Kallhälls blandade bostadsbestånd. 
