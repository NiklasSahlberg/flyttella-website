...
export const metadata: Metadata = {
  title: 'Flyttfirma i Åkersberga | Lokal Flyttservice | Flyttella',
  description: 'Erfaren flyttfirma med gedigen lokalkännedom i Åkersberga. Vi erbjuder professionell flytthjälp, flyttstädning och packning med fokus på kvalitet och kundnöjdhet. Kontakta oss för en smidig flytt!',
  keywords: 'flyttfirma åkersberga, flytthjälp åkersberga, flyttstädning åkersberga, packning åkersberga, bohagsflytt åkersberga',
  openGraph: {
    title: 'Flyttfirma i Åkersberga | Lokal Flyttservice | Flyttella',
    description: 'Erfaren flyttfirma med gedigen lokalkännedom i Åkersberga. Vi erbjuder professionell flytthjälp, flyttstädning och packning med fokus på kvalitet och kundnöjdhet.',
  },
};
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            <h2 className="text-2xl md:text-3xl font-bold text-[#0F172A] mb-8 text-center">
              Varför välja oss som din flyttfirma i Åkersberga?
            </h2>
