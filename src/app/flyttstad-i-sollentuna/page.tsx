...
export const metadata: Metadata = {
  title: 'Flyttstäd i Sollentuna | Professionell Städservice | Flyttella',
  description: 'Professionell flyttstädning i Sollentuna, Stockholm. Vi erbjuder grundlig flyttstädning, kontorsstädning och hemstädning i Sollentuna och omnejd.',
  keywords: 'flyttstäd sollentuna, flyttstädning sollentuna, städfirma sollentuna, flyttstädning stockholm',
  openGraph: {
    title: 'Flyttstäd i Sollentuna | Professionell Städservice | Flyttella',
    description: 'Professionell flyttstädning i Sollentuna, Stockholm.',
    type: 'website',
    locale: 'sv_SE',
  },
};

export default function FlyttstadSollentunaPage() {
  return (
          ...
          <div className="max-w-4xl mx-auto">
            <div className="text-center mb-12">
              <h1 className="text-4xl md:text-6xl font-bold mb-6">
                Flyttstäd i Sollentuna
              </h1>
              <p className="text-xl md:text-2xl text-white/90 mb-8">
                Professionell flyttstädning i Sollentuna, Stockholm. Vi har erfarenhet av städning i villor, lägenheter och kontor.
              </p>
            </div>
      ...
      <div className="container mx-auto px-4 py-16">
        <div className="max-w-4xl mx-auto mb-16">
          <div className="bg-white rounded-xl shadow-lg p-8 md:p-12">
            <h2 className="text-2xl md:text-3xl font-bold text-[#0F172A] mb-6">
              Professionell flyttstädning i Sollentuna, Stockholm
            </h2>
            <div className="space-y-4 text-gray-600">
              <p className="text-lg">
                Som ledande städfirma i Sollentuna har vi specialiserat oss på att erbjuda grundlig och professionell flyttstädning. 
                Sollentuna är känt för sina välskötta villor, moderna lägenheter och professionella kontorsmiljöer.
              </p>
              <p className="text-lg">
                Vi förstår de specifika kraven för städning i Sollentuna - från villor med trädgårdar till moderna kontorslokaler. 
        ...
        <div className="text-center">
          <h2 className="text-3xl font-bold text-[#0F172A] mb-6">
            Boka din städtjänst i Sollentuna idag
          </h2>
          <p className="text-lg text-gray-600 mb-8 max-w-2xl mx-auto">
            Vi erbjuder skräddarsydda städlösningar för alla typer av bostäder och kontor i Sollentuna. 
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            "@type": "LocalBusiness",
            "name": "Flyttella - Flyttstäd i Sollentuna",
            "description": "Professionell flyttstädning i Sollentuna, Stockholm. Vi erbjuder flyttstädning, kontorsstädning och hemstädning.",
            "url": "https://flyttella.se/flyttstad-i-sollentuna",
