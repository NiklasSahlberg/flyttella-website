            ...
            <div className="bg-gray-50 rounded-lg p-6">
              ...
              <ul className="text-left space-y-3 text-gray-600">
                <li className="flex items-start">
                  ...
                  <span>Vi granskar din förfrågan och beräknar en detaljerad offert</span>
                </li>
                <li className="flex items-start">
                  <svg className="w-5 h-5 text-[#10B981] mt-1 mr-3 flex-shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" />
                  </svg>
                  <span>En av våra flyttspecialister kontaktar dig inom kort</span>
                </li>
                <li className="flex items-start">
                  <svg className="w-5 h-5 text-[#10B981] mt-1 mr-3 flex-shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" />
                  </svg>
                  <span>Vi går igenom detaljerna och svarar på dina frågor</span>
                </li>
              </ul>
            </div>
