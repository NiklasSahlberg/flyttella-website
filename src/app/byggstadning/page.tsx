          ...
          <div className="mx-auto px-4 md:px-24 relative z-10">
            <div className="bg-gradient-to-r from-[#0F172A] to-[#10B981] text-white rounded-2xl p-4 md:p-8 mb-6 md:mb-8 w-full">
              <div className="w-full">
                ...
                <div className="text-center mb-6 md:mb-8 hidden md:block"><p className="text-white text-base md:text-lg max-w-4xl mx-auto mb-4 md:mb-6 leading-relaxed">Vår byggstädningsprocess är enkel och trygg. Fyll i formuläret – du får pris på 1 minut och kan bekräfta digitalt. Samma dag eller senast nästkommande vardag ringer vi upp för att stämma av omfattning, material, åtkomlighet och tidplan samt eventuella tillval.</p><p className="text-white text-base md:text-lg max-w-4xl mx-auto mb-4 md:mb-6 leading-relaxed">När allt är förankrat planerar vi arbetet och genomför både grov- och finstädning enligt tydlig checklista: dammbindning och dammsugning av byggdamm, avtorkning av alla ytor, kök och badrum samt slutinspektion. Resultatet är dammfritt, prydligt och redo för inflytt.</p></div>
