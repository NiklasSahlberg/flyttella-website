            ...
            <div className="bg-gradient-to-r from-[#0F172A] to-[#10B981] text-white py-12 relative overflow-hidden">
              ...
              <div className="relative z-10 px-4 text-center">
                <h1 className="text-4xl font-bold mb-4">
                  Professionell byggstädning i Stockholm
                </h1>
                <p className="text-xl mb-6">
                  Grov- och finstädning efter renovering och bygge
                </p>
              </div>
            </div>
          </div>
              ...
              <motion.div className="space-y-12 md:space-y-16" variants={staggerContainer} initial="initial" whileInView="animate" viewport={{ once: true }}>
                ...
                <div className="hidden lg:block absolute -right-72 xl:-right-72 lg:-right-48 top-[1570px] w-64 sidebar-widget">
                  <div className="sticky top-8">
                    <div className="bg-gradient-to-r from-[#0F172A] to-[#10B981] rounded-xl p-6 shadow-lg text-white flex flex-col min-h-[180px] h-full">
                      <div className="absolute inset-0 opacity-10 pointer-events-none" style={{ backgroundImage: 'radial-gradient(circle, #fff 1px, transparent 1px)', backgroundSize: '20px 20px' }} />
                      <div className="flex items-center gap-3 mb-4 relative"><span className="text-4xl">🪟</span><h3 className="text-xl font-bold text-white">Fönsterputs</h3></div>
                      <p className="text-sm text-gray-100 mb-4 relative">Kristallklara fönster året runt – invändigt och utvändigt där det är säkert och åtkomligt.</p>
                      <div className="mt-auto relative">
                        <Link href="/fonsterputsning" className="inline-flex items-center bg-white text-[#0F172A] px-4 py-2 rounded-full hover:bg-opacity-90 transition-opacity font-medium group text-sm">Läs mer<svg xmlns="http://www.w3.org/2000/svg" className="h-4 w-4 ml-2 group-hover:translate-x-1 transition-transform" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 5l7 7-7 7" /></svg></Link>
                      </div>
                    </div>
                  </div>
                </div>
              ...
              <div className="relative flex flex-col lg:flex-row items-stretch gap-16">
                ...
                <motion.div className="w-full lg:w-4/5 space-y-4 lg:space-y-8 flex flex-col justify-center" initial="initial" whileInView="animate" viewport={{ once: true, amount: 0.2 }} variants={fadeInUp} transition={{ duration: 0.8, delay: 0.4 }}>
                  <div className="hidden lg:block space-y-8">
                    ...
                    <p className="text-xl md:text-2xl text-[#0F172A] leading-relaxed">Snabb återkoppling, flexibla tider och ett lösningsorienterat arbetssätt gör att du snabbt kan njuta av ett prydligt hem igen. Du får pris direkt och kan boka enkelt.</p>
                  </div>
            ...
            <div className="max-w-7xl mx-auto">
              ...
              <div className="grid grid-cols-1 gap-12">
                ...
                <motion.div className="relative bg-gradient-to-r from-[#0F172A] to-[#10B981] rounded-xl p-8 md:p-12 shadow-lg text-white flex flex-col h-full md:min-h-[340px]" initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.5, delay: 0.2 }}>
                  ...
                  <p className="hidden md:block text-lg text-gray-100 mb-8 relative">Fokus på första intrycket: skinande kök och badrum, polerade ytor och speglar, snyggt ordnade detaljer och doftneutralt resultat. Fönsterputs som tillval. Vi följer en visningsanpassad checklista och tidsplan i samråd med dig eller mäklaren.</p>
                ...
                <motion.div className="relative bg-gradient-to-r from-[#0F172A] to-[#10B981] rounded-xl p-8 md:p-12 shadow-lg text-white flex flex-col h-full md:min-h-[340px]" initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.5, delay: 0.3 }}>
                  ...
                  <p className="hidden md:block text-lg text-gray-100 mb-8 relative">Vi anpassar städningen efter dina behov och önskemål – från kök och badrum till vardagsrum och sovrum. Miljövänliga produkter och flexibla intervaller. Som tillval erbjuds fönsterputs och storstädning. Samma erfarna städare när möjligt för kontinuitet och trygghet.</p>
          ...
          <div className="mx-auto px-4 md:px-24 relative z-10">
            <div className="bg-gradient-to-r from-[#0F172A] to-[#10B981] text-white rounded-2xl p-4 md:p-8 mb-6 md:mb-8 w-full">
              <div className="w-full">
                ...
                <div className="text-center mb-6 md:mb-8 hidden md:block"><p className="text-white text-base md:text-lg max-w-4xl mx-auto mb-4 md:mb-6 leading-relaxed">Vår byggstädningsprocess är enkel och trygg. Fyll i formuläret – du får pris snabbt och eneklt och kan bekräfta digitalt. Samma dag eller senast nästkommande vardag ringer vi upp för att stämma av omfattning, material, åtkomlighet och tidsplan samt eventuella tillval.</p><p className="text-white text-base md:text-lg max-w-4xl mx-auto mb-4 md:mb-6 leading-relaxed">När allt är förankrat planerar vi arbetet och genomför både grov- och finstädning enligt tydlig checklista: dammtorkning och dammsugning av byggdamm, avtorkning av alla ytor, kök och badrum. Resultatet är dammfritt, prydligt och redo för inflytt.</p></div>
                <div className="text-center mb-4 md:mb-8"><p className="text-white text-base md:text-lg max-w-4xl mx-auto mb-4">Priset baseras på boyta, omfattning och åtkomlighet. Alla priser är fasta utan dolda avgifter. RUT‑avdrag hanteras automatiskt och du kan omboka/avboka kostnadsfritt upp till 24 timmar innan.</p></div>
        ...
        <section className="py-16 bg-gray-50">
          <div className="container mx-auto px-4">
            <div className="max-w-4xl mx-auto">
              <div className="text-center mb-12"><h2 className="text-3xl md:text-4xl font-bold text-[#0F172A] mb-4">Läs mer om byggstädning</h2><p className="text-lg text-gray-600 max-w-2xl mx-auto">Tips efter renovering: dammfritt, rätt ordning och hur du snabbast får det inflyttningsklart.</p></div>
