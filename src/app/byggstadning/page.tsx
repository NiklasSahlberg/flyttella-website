              ...
              <motion.div className="space-y-12 md:space-y-16" variants={staggerContainer} initial="initial" whileInView="animate" viewport={{ once: true }}>
                ...
                {(locale === 'sv' ? [
                  ...
                  },
                  {
                    title: '',
                    content: (
                      <div className="w-full max-w-6xl mx-auto flex justify-center my-12"><img src="/byggstadning.webp" alt="Byggstädning" className="w-full h-80 md:h-96 rounded-lg shadow-lg object-cover" /></div>
                    ),
                    icon: ''
                  },
                  {
                  ...
                  },
                  {
                    title: '',
                    content: (
                      <div className="w-full max-w-6xl mx-auto flex justify-center my-12"><img src="/byggstadning_badrum.webp" alt="Byggstädning badrum" className="w-full h-80 md:h-96 rounded-lg shadow-lg object-cover" /></div>
                    ),
                    icon: ''
                  },
                  {
                  ...
                  },
                  {
                    title: '',
                    content: (
                      <div className="w-full max-w-6xl mx-auto flex justify-center my-12"><img src="/byggstadning.webp" alt="Construction Cleaning" className="w-full h-80 md:h-96 rounded-lg shadow-lg object-cover" /></div>
                    ),
                    icon: ''
                  },
                  {
                  ...
                  },
                  {
                    title: '',
                    content: (
                      <div className="w-full max-w-6xl mx-auto flex justify-center my-12"><img src="/byggstadning_badrum.webp" alt="Construction Cleaning Bathroom" className="w-full h-80 md:h-96 rounded-lg shadow-lg object-cover" /></div>
                    ),
                    icon: ''
                  },
                  {
              ...
              <div className="bg-gradient-to-r from-[#0F172A] to-[#10B981] text-white rounded-2xl p-6 md:p-8">
                <div className="flex flex-col lg:flex-row items-stretch gap-8 h-full">
                  ...
                  <div className="flex-1 flex justify-center lg:justify-end lg:self-stretch">
                    <div className="w-full h-full flex items-stretch"><img src="/cleaning_lady.webp" alt="Städpersonal i Stockholm - Flyttella" className="rounded-xl shadow-lg object-cover w-full h-full" style={{ objectPosition: '30% 80%' }} /></div>
                  </div>
                </div>
              </div>
            </div>
