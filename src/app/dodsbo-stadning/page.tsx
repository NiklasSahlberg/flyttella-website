              ...
              <motion.div className="space-y-12 md:space-y-16" variants={staggerContainer} initial="initial" whileInView="animate" viewport={{ once: true }}>
                {(locale === 'sv' ? [
                  ...
                  },
                  {
                    ...
                    content: (
                      <div className="w-full max-w-6xl mx-auto flex justify-center my-12">
                        <img src="/fonsterputs_intro.webp" alt="Stöd i en svår tid" className="w-full h-80 md:h-96 rounded-lg shadow-lg object-cover" />
                      </div>
                    ),
                    icon: ''
                  },
                  ...
                  },
                  {
                    ...
                    content: (
                      <div className="w-full max-w-6xl mx-auto flex justify-center my-12">
                        <img src="/cleaning_background.webp" alt="Dödsbostädning – vad ingår" className="w-full h-80 md:h-96 rounded-lg shadow-lg object-cover" />
                      </div>
                    ),
                    icon: ''
                  },
                  ...
                  },
                  {
                    ...
                    content: (
                      <div className="w-full max-w-6xl mx-auto flex justify-center my-12">
                        <img src="/fonsterputs_intro.webp" alt="Support in a difficult time" className="w-full h-80 md:h-96 rounded-lg shadow-lg object-cover" />
                      </div>
                    ),
                    icon: ''
                  },
                  ...
                  },
                  {
                    ...
                    content: (
                      <div className="w-full max-w-6xl mx-auto flex justify-center my-12">
                        <img src="/cleaning_background.webp" alt="Estate Cleaning – what is included" className="w-full h-80 md:h-96 rounded-lg shadow-lg object-cover" />
                      </div>
                    ),
                    icon: ''
                  },
            ...
            <div className="max-w-7xl mx-auto">
              <div className="grid grid-cols-3 gap-6">
                ...
                <motion.div className="relative bg-gradient-to-r from-[#0F172A] to-[#10B981] rounded-xl p-5 shadow-lg text-white flex flex-col h-full" initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.4, delay: 0.05 }}>
                  ...
                  <p className="text-sm text-gray-100 mb-4 relative">{locale === 'sv' ? 'Grundlig storstädning – kök, badrum och svåråtkomliga ytor.' : 'Thorough deep cleaning – kitchen, bathroom and hard-to-reach areas.'}</p>
