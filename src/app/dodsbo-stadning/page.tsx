                ...
                >
                  <div className="relative h-80 lg:h-full w-full overflow-hidden rounded-2xl">
                    <img 
                      ...
                      style={{ objectPosition: '30% 75%', transform: 'scale(1.10)' }} 
                    />
                  </div>
                </motion.div>
                <motion.div 
                ...
                >
                  <div className="hidden lg:block space-y-8">
                    <p className="text-xl md:text-2xl text-[#0F172A] leading-relaxed">
                      Flyttella är en städfirma i Stockholm med erfarenhet av dödsbostädning, flyttstädning och hemstädning. Vi erbjuder fasta priser och personlig service i hela Storstockholm.
                    </p>
                    <p className="text-xl md:text-2xl text-[#0F172A] leading-relaxed">
                      Vi arbetar strukturerat med tydliga checklistor, miljövänliga produkter och respektfullt bemötande. Målet är ett tryggt, värdigt och prydligt resultat.
                    </p>
                    <p className="text-xl md:text-2xl text-[#0F172A] leading-relaxed">
                      Du får pris direkt, smidig bokning och snabb återkoppling. Våra höga kundbetyg visar att vår process fungerar – i varje steg.
                    </p>
                  </div>
                  <div className="lg:hidden space-y-4">
                    ...
                    <p className="text-xl md:text-2xl text-[#0F172A] leading-relaxed">
                      Fasta priser, tydliga checklistor och personlig service.
                    </p>
                    {!showFullAboutText && (
                      <button
                    ...
                    {showFullAboutText && (
                      ...
                      >
                        <p className="text-xl md:text-2xl text-[#0F172A] leading-relaxed">
                          Vi tar hand om städningen med respekt och noggrannhet. Smidig offert, enkel bokning och personlig kontakt genom hela processen.
                        </p>
            ...
            <motion.div className="relative bg-gradient-to-r from-[#0F172A] to-[#10B981] rounded-xl p-6 md:p-10 shadow-lg text-white flex flex-col items-center justify-center min-h-[180px] md:minh-[200px] w-full max-w-sm sm:max-w-md md:max-w-3xl mx-auto text-center" initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.5 }}>
              ...
              <div className="relative z-10 text-center">
                <motion.div whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.95 }} className="inline-block">
                  <Link href="#dodsbo-offert" className="inline-flex items-center bg-white text-[#0F172A] px-5 py-2.5 md:px-6 md:py-3 rounded-full hover:bg-opacity-90 transition-opacity font-medium group text-sm md:text-base">
                    Få gratis offert
