...
export const metadata: Metadata = {
  title: 'Flyttstäd i Lidingö | Professionell Städservice | Flyttella',
  description: 'Professionell flyttstädning i Lidingö, Stockholm. Vi erbjuder grundlig flyttstädning, kontorsstädning och hemstädning i Lidingö och omnejd.',
  keywords: 'flyttstäd lidingö, flyttstädning lidingö, städfirma lidingö, flyttstädning stockholm',
  openGraph: {
    title: 'Flyttstäd i Lidingö | Professionell Städservice | Flyttella',
    description: 'Professionell flyttstädning i Lidingö, Stockholm.',
    type: 'website',
    locale: 'sv_SE',
  },
};

export default function FlyttstadLidingoPage() {
  return (
          ...
          <div className="max-w-4xl mx-auto">
            <div className="text-center mb-12">
              ...
              <p className="text-xl md:text-2xl text-white/90 mb-8">
                Professionell flyttstädning i Lidingö, Stockholm. Vi har erfarenhet av städning i villor, lägenheter och kontor.
              </p>
            </div>
      ...
      <div className="container mx-auto px-4 py-16">
        <div className="max-w-4xl mx-auto mb-16">
          <div className="bg-white rounded-xl shadow-lg p-8 md:p-12">
            <h2 className="text-2xl md:text-3xl font-bold text-[#0F172A] mb-6">
              Professionell flyttstädning i Lidingö, Stockholm
            </h2>
            <div className="space-y-4 text-gray-600">
              <p className="text-lg">
                Som ledande städfirma i Lidingö har vi specialiserat oss på att erbjuda grundlig och professionell flyttstädning. 
                Lidingö är känt för sina välskötta villor, moderna lägenheter och professionella kontorsmiljöer.
              </p>
              <p className="text-lg">
                Vi förstår de specifika kraven för städning i Lidingö - från villor med trädgårdar till moderna kontorslokaler. 
        ...
        <div className="text-center">
          <h2 className="text-3xl font-bold text-[#0F172A] mb-6">
            Boka din städtjänst i Lidingö idag
          </h2>
          <p className="text-lg text-gray-600 mb-8 max-w-2xl mx-auto">
            Vi erbjuder skräddarsydda städlösningar för alla typer av bostäder och kontor i Lidingö. 
