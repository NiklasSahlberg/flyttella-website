...
export const metadata: Metadata = {
  title: 'Flyttfirma i Älvsjö | Professionell Flyttservice | Flyttella',
  description: 'Professionell flyttfirma i Älvsjö, Stockholm. Vi erbjuder flyttstädning, packning och bohagsflytt i Älvsjö och omnejd. Erfarenhet med flyttar i villor, lägenheter och större bostäder. Snabb service och konkurrenskraftiga priser.',
  keywords: 'flyttfirma älvsjö, flyttstädning älvsjö, flyttfirma stockholm, flyttstädning stockholm, bohagsflytt älvsjö, flytt i villa, flytt i lägenhet, älvsjö flytt',
  openGraph: {
    title: 'Flyttfirma i Älvsjö | Professionell Flyttservice | Flyttella',
    description: 'Professionell flyttfirma i Älvsjö, Stockholm. Vi erbjuder flyttstädning, packning och bohagsflytt i Älvsjö och omnejd. Erfarenhet med flyttar i villor och lägenheter.',
    type: 'website',
    locale: 'sv_SE',
  },
};

export default function FlyttfirmaAlvsjoPage() {
  return (
    <main className="min-h-screen">
          ...
          <div className="max-w-4xl mx-auto">
            <div className="text-center mb-12">
              ...
              <p className="text-xl md:text-2xl text-white/90 mb-8">
                Professionell flyttservice i Älvsjö, Stockholm. Vi har erfarenhet av både villor och lägenheter i detta välkomnande område nära Älvsjö station och Stockholm International Fairs.
              </p>
            </div>
      ...
      <div className="container mx-auto px-4 py-16">
        ...
        <div className="max-w-4xl mx-auto mb-16">
          <div className="bg-white rounded-xl shadow-lg p-8 md:p-12">
            <h2 className="text-2xl md:text-3xl font-bold text-[#0F172A] mb-6">
              Professionell flyttservice i Älvsjö, Stockholm
            </h2>
            <div className="space-y-4 text-gray-600">
              <p className="text-lg">
                Som ledande flyttfirma i Älvsjö har vi specialiserat oss på att hantera flyttar i detta välkomnande område i södra Stockholm. 
                Älvsjö är känt för sin närhet till Älvsjö station, Stockholm International Fairs, och sin blandning av villor, radhus och lägenheter.
              </p>
              <p className="text-lg">
                Vi förstår de specifika utmaningarna med att flytta i Älvsjö - från villor med trädgårdar till lägenheter nära kollektivtrafik. 
        ...
        {/* Älvsjö Specific Features */}
        <div className="bg-white rounded-lg shadow-lg p-8 mb-16">
          <h2 className="text-2xl font-bold text-[#0F172A] mb-6">
            Varför välja oss som din flyttfirma i Älvsjö?
          </h2>
          <div className="grid md:grid-cols-2 gap-8">
            <div>
              ...
              <ul className="space-y-2">
                {[
                  "Känner till Älvsjös gator och områden",
                  "Erfarenhet med villor nära Älvsjö station",
                  "Känner till parkeringsmöjligheter",
                  "Förstår trafikflöden i området",
                  "Känner till Stockholm International Fairs"
                ].map((item, index) => (
                  <li key={index} className="flex items-start">
            ...
            <div>
              ...
              <ul className="space-y-2">
                {[
                  ...
                  "Hantering av radhus och villor",
                  "Flyttar nära kollektivtrafik",
        ...
        <div className="bg-gradient-to-r from-[#0F172A] to-[#10B981] rounded-lg shadow-lg p-8 text-white mb-16">
          ...
          <ul className="grid md:grid-cols-2 gap-4">
            {[
              "Erfarenhet med alla bostadstyper i Älvsjö",
        ...
        <div className="text-center">
          <h2 className="text-3xl font-bold text-[#0F172A] mb-6">
            Boka din flytt i Älvsjö idag
          </h2>
          <p className="text-lg text-gray-600 mb-8 max-w-2xl mx-auto">
            Vi erbjuder skräddarsydda lösningar för alla typer av flyttar i Älvsjö. 
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            "@type": "LocalBusiness",
            "name": "Flyttella - Flyttfirma i Älvsjö",
            "description": "Professionell flyttfirma i Älvsjö, Stockholm. Vi erbjuder flyttstädning, packning och bohagsflytt.",
            "url": "https://flyttella.se/flyttfirma-i-alvsjo",
