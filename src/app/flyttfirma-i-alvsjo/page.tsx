    ...
    <>
      ...
      <div className="relative z-20 max-w-7xl mx-auto" style={{ marginTop: '-8rem' }}>
        <motion.div
          ...
          viewport={{ once: true }}
        >
          <h3 className="text-3xl md:text-4xl font-bold text-[#0F172A] mb-6 text-center">{t('alvsjo.experienceSection.title')}</h3>
  ...
  return (
    <main className="overflow-hidden">
      <div className="main-zoom">
        ...
        <div className="relative py-2 bg-white text-[#0F172A] overflow-hidden">
          ...
          <div className="md:hidden mx-auto px-4 pb-8">
            {selectedServiceType === 'flyttstad' ? (
              ...
              <FlyttoffertForm 
                mode="widget" 
                backgroundImage="/alvsjo-flyttfirma.jpg" 
          ...
          <div className="md:hidden mx-auto px-4 py-6">
            <div className="bg-gradient-to-r from-[#0F172A] to-[#10B981] text-white rounded-2xl p-6 relative overflow-hidden">
              ...
              <div 
                ...
                style={{
                  backgroundImage: 'url(/alvsjo-flyttfirma.jpg)',
                  backgroundSize: 'cover',
          ...
          <div className="relative z-40 max-w-[90rem] mx-auto px-4 md:px-8 lg:px-16">
            ...
            >
              ...
              <div className="lg:hidden mb-6">
                ...
                <h3 className="text-3xl md:text-4xl lg:text-5xl font-bold text-[#0F172A] mb-8 md:mb-12 lg:mb-16 text-center">{t('alvsjo.about.title')}</h3>
              ...
              <div className="relative flex flex-col lg:flex-row items-stretch gap-8 md:gap-12 lg:gap-16">
                ...
                <div className="hidden lg:block space-y-8">
                  <p className="text-xl md:text-2xl text-[#0F172A] leading-relaxed">
                    {t('alvsjo.about.desktop')}
                  </p>
                  <p className="text-xl md:text-2xl text-[#0F172A] leading-relaxed">
                    {t('alvsjo.about.desktop2')}
                  </p>
                  <p className="text-xl md:text-2xl text-[#0F172A] leading-relaxed">
                    {t('alvsjo.about.desktop3')}
                  </p>
                </div>
                  ...
                  <div className="lg:hidden space-y-4 text-center">
                    <div className="text-left inline-block max-w-2xl">
                      <p className="text-base md:text-lg text-[#0F172A] leading-relaxed">
                        {t('alvsjo.about.mobile')}
                        {showFullAboutText && (
                          <>
                            {' '}{t('alvsjo.about.mobileExpanded')}
                          </>
                        )}
                      </p>
                      {showFullAboutText && (
                        <p className="text-base md:text-lg text-[#0F172A] leading-relaxed mt-4">
                          {t('alvsjo.about.mobileExpanded2')}
                        </p>
                      )}
                    </div>
        ...
        <ReviewsWidget 
          location="Älvsjö"
          title={t('alvsjo.customerReviews.title')}
          subtitle={t('alvsjo.reviews.subtitle')}
          description={t('alvsjo.reviews.description')}
          badgeAlt={t('alvsjo.reviews.badgeAlt')}
          arrowText={t('alvsjo.reviews.arrowText')}
        />
          ...
          <div className="container mx-auto px-4">
            <div className="flex flex-col md:flex-row items-center gap-6 md:gap-12">
              ...
              <div className="w-full md:hidden text-center mb-4">
                <h2 className="text-2xl md:text-4xl font-extrabold text-[#0F172A] mb-3 md:mb-6">{t('alvsjo.awards.title')}</h2>
                <p className="text-lg md:text-2xl text-gray-700 leading-relaxed">
                  {t('alvsjo.awards.description')}
                </p>
              </div>
              ...
              <div className="hidden md:flex w-full md:w-2/5 md:order-1 text-left flex-col items-start justify-center">
                <h2 className="text-3xl md:text-4xl font-extrabold text-[#0F172A] mb-6">{t('alvsjo.awards.title')}</h2>
        ...
        >
          <div className="container mx-auto px-4 relative z-10">
              ...
              <motion.h2 
                ...
                id="upptack-tjanster"
              >
                  {t('alvsjo.servicesSection.title')}
              </motion.h2>
              <motion.p 
              ...
              >
                  {t('alvsjo.servicesSection.description')}
              </motion.p>
              <motion.div
              ...
              >
                ...
                >
                  ...
                  >
                    {t('alvsjo.servicesSection.privateServices')}
                    <motion.svg 
                      xmlns="http://www.w3.org/2000/svg" 
                      className="h-5 w-5 ml-2 group-hover:translate-x-1 transition-transform" 
                      fill="none" 
                ...
                <div>
                  ...
                  <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
                    <TipCard
                      ...
                      imageAlt="Flyttplanering i Älvsjö - Tips för flytt"
                      content={
                ...
                <div>
                  ...
                  <div className="grid md:grid-cols-2 gap-8 max-w-4xl mx-auto">
                    <TipCard
                        ...
                        imageAlt="Smidig flyttdag med flyttfirma i Älvsjö"
            ...
            <div className="w-full">
              <div className="text-center mb-8 md:mb-12">
                <h2 className="text-2xl md:text-4xl font-bold text-[#0F172A] mb-3 md:mb-4">
                  {t('alvsjo.blogSection.title')}
                </h2>
                <p className="text-base md:text-lg text-gray-600 max-w-2xl mx-auto px-4">
                  {t('alvsjo.blogSection.description')}
                </p>
              </div>
              ...
              >
                    ...
                    <img 
                      ...
                      alt="Pålitlig flyttfirma i Älvsjö - Specialister på flytt i grönområden och familjevänliga miljöer" 
            ...
            <div className="max-w-4xl mx-auto">
              ...
              <div className="space-y-4">
                {[
                  {
                    id: "akersberga-1",
                    question: t('alvsjo.faq.items.0.question'),
                    answer: t('alvsjo.faq.items.0.answer')
                  },
                  {
                    id: "akersberga-2",
                    question: t('alvsjo.faq.items.1.question'),
                    answer: t('alvsjo.faq.items.1.answer')
                  },
                  {
                    id: "akersberga-3",
                    question: t('alvsjo.faq.items.2.question'),
                    answer: t('alvsjo.faq.items.2.answer')
                  },
                  {
                    id: "akersberga-4",
                    question: t('alvsjo.faq.items.3.question'),
                    answer: t('alvsjo.faq.items.3.answer')
                  },
                  {
                    id: "akersberga-5",
                    question: t('alvsjo.faq.items.4.question'),
                    answer: t('alvsjo.faq.items.4.answer')
                  },
                ].map((faq, index) => (
                  <motion.div
                    key={faq.id}
              ...
              <div className="text-center mt-12">
                <p className="text-lg text-gray-600 mb-6">
                  {t('alvsjo.faqFooter.title')}
                </p>
                <Link 
                  href="/faq" 
                  className="inline-flex items-center bg-gradient-to-r from-[#0F172A] to-[#10B981] text-white px-8 py-4 rounded-full hover:opacity-90 transition-opacity font-medium group"
                >
                  {t('alvsjo.faqFooter.linkText')}
                  <svg 
                    xmlns="http://www.w3.org/2000/svg" 
                    className="h-5 w-5 ml-2 group-hover:translate-x-1 transition-transform" 
                    fill="none" 
