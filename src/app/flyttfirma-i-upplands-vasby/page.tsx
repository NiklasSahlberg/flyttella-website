...
export const metadata: Metadata = {
  title: 'Flyttfirma i Upplands Väsby | Professionell Flyttservice | Flyttella',
  description: 'Professionell flyttfirma i Upplands Väsby. Vi erbjuder flyttstädning, packning och bohagsflytt i Upplands Väsby. Snabb service och konkurrenskraftiga priser. Boka din flytt idag!',
  keywords: 'flyttfirma upplands väsby, flyttstädning upplands väsby, flyttfirma stockholm, flyttstädning stockholm, bohagsflytt upplands väsby',
  openGraph: {
    title: 'Flyttfirma i Upplands Väsby | Professionell Flyttservice | Flyttella',
    description: 'Professionell flyttfirma i Upplands Väsby. Vi erbjuder flyttstädning, packning och bohagsflytt i Upplands Väsby. Snabb service och konkurrenskraftiga priser.',
    type: 'website',
    locale: 'sv_SE',
  },
};

export default function FlyttfirmaUpplandsVasbyPage() {
  return (
          ...
          <div className="max-w-4xl mx-auto">
            <div className="text-center mb-12">
              <h1 className="text-4xl md:text-6xl font-bold mb-6">
                Flyttfirma i Upplands Väsby
              </h1>
              <p className="text-xl md:text-2xl text-white/90 mb-8">
                Professionell flyttservice i Upplands Väsby - från lägenheter i centrum till villor i utkanten. Vi förstår de unika utmaningarna med att flytta i Upplands Väsbys olika områden.
              </p>
            </div>
      ...
      <div className="container mx-auto px-4 py-16">
        ...
        <div className="max-w-4xl mx-auto mb-16">
          <div className="bg-white rounded-xl shadow-lg p-8 md:p-12">
            <h2 className="text-2xl md:text-3xl font-bold text-[#0F172A] mb-6">
              Professionell flyttservice i Upplands Väsby
            </h2>
            <div className="space-y-4 text-gray-600">
              <p className="text-lg">
                Som etablerad flyttfirma i Upplands Väsby erbjuder vi en komplett flyttservice som täcker alla dina behov. 
              ...
              <p className="text-lg">
                Vi känner väl till Upplands Väsbys olika områden och de särskilda krav som ställs vid flytt här. 
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8 mb-16">
          ...
          <div className="bg-white rounded-lg shadow-lg p-8">
            ...
            <ul className="space-y-3">
              {[
                "Erfarna flyttare i Upplands Väsby",
        ...
        <div className="bg-gradient-to-r from-[#0F172A] to-[#10B981] rounded-lg shadow-lg p-8 text-white mb-16">
          <h2 className="text-2xl font-bold mb-6">
            Varför välja oss som din flyttfirma i Upplands Väsby?
          </h2>
          <ul className="grid md:grid-cols-2 gap-4">
            {[
              "Stor erfarenhet av lokala flyttar",
              "God kännedom om Upplands Väsby",
        ...
        <div className="max-w-4xl mx-auto text-center mb-16">
          <h2 className="text-2xl md:text-3xl font-bold text-[#0F172A] mb-6">
            Vi flyttar i hela Upplands Väsby med omnejd
          </h2>
          <p className="text-lg text-gray-600 mb-8">
            Vi utför flyttuppdrag i hela Upplands Väsby och närliggande områden som Sollentuna, 
            Upplands-Bro och Sigtuna. Med vår lokalkännedom och erfarenhet 
        ...
        <div className="text-center">
          <h2 className="text-3xl font-bold text-[#0F172A] mb-6">
            Boka din flytt i Upplands Väsby idag
          </h2>
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            "@type": "LocalBusiness",
            "name": "Flyttella - Flyttfirma i Upplands Väsby",
            ...
            "url": "https://flyttella.se/flyttfirma-i-upplands-vasby",
