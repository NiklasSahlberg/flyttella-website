...
export const metadata: Metadata = {
  title: 'Flyttstäd i Sundbyberg | Professionell Städservice | Flyttella',
  description: 'Professionell flyttstädning i Sundbyberg, Stockholm. Vi erbjuder grundlig flyttstädning, kontorsstädning och hemstädning i Sundbyberg och omnejd.',
  keywords: 'flyttstäd sundbyberg, flyttstädning sundbyberg, städfirma sundbyberg, flyttstädning stockholm',
  openGraph: {
    title: 'Flyttstäd i Sundbyberg | Professionell Städservice | Flyttella',
    description: 'Professionell flyttstädning i Sundbyberg, Stockholm.',
    type: 'website',
    locale: 'sv_SE',
  },
};

export default function FlyttstadSundbybergPage() {
  return (
          ...
          <div className="max-w-4xl mx-auto">
            <div className="text-center mb-12">
              <h1 className="text-4xl md:text-6xl font-bold mb-6">
                Flyttstäd i Sundbyberg
              </h1>
              <p className="text-xl md:text-2xl text-white/90 mb-8">
                Professionell flyttstädning i Sundbyberg, Stockholm. Vi har erfarenhet av städning i lägenheter, kontor och bostäder i detta expansiva område.
              </p>
            </div>
      ...
      <div className="container mx-auto px-4 py-16">
        <div className="max-w-4xl mx-auto mb-16">
          <div className="bg-white rounded-xl shadow-lg p-8 md:p-12">
            <h2 className="text-2xl md:text-3xl font-bold text-[#0F172A] mb-6">
              Professionell flyttstädning i Sundbyberg, Stockholm
            </h2>
            <div className="space-y-4 text-gray-600">
              <p className="text-lg">
                Som ledande städfirma i Sundbyberg har vi specialiserat oss på att erbjuda grundlig och professionell flyttstädning. Sundbyberg är ett expansivt område med moderna lägenheter, kontor och bostadsområden som kräver noggrann städning.
              </p>
              <p className="text-lg">
                Vi förstår de specifika kraven för städning i Sundbyberg - från moderna lägenheter till kontor. Vår erfarenhet och lokalkännedom säkerställer en skinande ren bostad eller kontorslokal.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="text-center">
          <h2 className="text-3xl font-bold text-[#0F172A] mb-6">
            Boka din städtjänst i Sundbyberg idag
          </h2>
          <p className="text-lg text-gray-600 mb-8 max-w-2xl mx-auto">
            Vi erbjuder skräddarsydda städlösningar för alla typer av bostäder och kontor i Sundbyberg. Kontakta oss för en kostnadsfri offert.
          </p>
          <Link 
            href="/fa-offert" 
