...
export const metadata: Metadata = {
  title: 'Flyttfirma i Haninge | Professionell Flyttservice | Flyttella',
  description: 'Professionell flyttfirma i Haninge. Vi erbjuder flyttstädning, packning och bohagsflytt i Haninge. Snabb service och konkurrenskraftiga priser. Boka din flytt idag!',
  keywords: 'flyttfirma haninge, flyttstädning haninge, flyttfirma stockholm, flyttstädning stockholm, bohagsflytt haninge',
  openGraph: {
    title: 'Flyttfirma i Haninge | Professionell Flyttservice | Flyttella',
    description: 'Professionell flyttfirma i Haninge. Vi erbjuder flyttstädning, packning och bohagsflytt i Haninge. Snabb service och konkurrenskraftiga priser.',
    type: 'website',
    locale: 'sv_SE',
  },
};

export default function FlyttfirmaHaningePage() {
  return (
          ...
          <div className="max-w-4xl mx-auto">
            <div className="text-center mb-12">
              <h1 className="text-4xl md:text-6xl font-bold mb-6">
                Flyttfirma i Haninge
              </h1>
              <p className="text-xl md:text-2xl text-white/90 mb-8">
                Professionell flyttservice i Haninge med gedigen erfarenhet. Vi erbjuder komplett flyttservice med bohagsflytt, flyttstädning och packning.
              </p>
            </div>
      ...
      <div className="container mx-auto px-4 py-16">
        ...
        <div className="max-w-4xl mx-auto mb-16">
          <div className="bg-white rounded-xl shadow-lg p-8 md:p-12">
            <h2 className="text-2xl md:text-3xl font-bold text-[#0F172A] mb-6">
              Professionell flyttservice i Haninge
            </h2>
            <div className="space-y-4 text-gray-600">
              <p className="text-lg">
                Som etablerad flyttfirma i Haninge erbjuder vi en komplett flyttservice som täcker alla dina behov. 
                Med vår omfattande erfarenhet har vi hjälpt många kunder med deras flyttar i Haninge och närliggande områden.
              </p>
              <p className="text-lg">
                Vi känner väl till Haninges olika områden och de utmaningar som kan uppstå vid flytt här. 
        ...
        <div className="bg-gradient-to-r from-[#0F172A] to-[#10B981] rounded-lg shadow-lg p-8 text-white mb-16">
          <h2 className="text-2xl font-bold mb-6">
            Varför välja oss som din flyttfirma i Haninge?
          </h2>
          <ul className="grid md:grid-cols-2 gap-4">
            {[
              "Stor erfarenhet av lokala flyttar",
              "God kännedom om Haninge",
        ...
        <div className="max-w-4xl mx-auto text-center mb-16">
          <h2 className="text-2xl md:text-3xl font-bold text-[#0F172A] mb-6">
            Vi flyttar i hela Haninge med omnejd
          </h2>
          <p className="text-lg text-gray-600 mb-8">
            Vi utför flyttuppdrag i hela Haninge och närliggande områden som Handen, 
            Jordbro, Vendelsö, Brandbergen och Västerhaninge. Med vår lokalkännedom 
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            "@type": "LocalBusiness",
            "name": "Flyttella - Flyttfirma i Haninge",
            ...
            "url": "https://flyttella.se/flyttfirma-i-haninge",
