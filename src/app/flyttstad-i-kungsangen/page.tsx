...
export const metadata: Metadata = {
  title: 'Flyttstäd i Kungsängen | Professionell Städservice | Flyttella',
  description: 'Professionell flyttstädning i Kungsängen, Stockholm. Vi erbjuder grundlig flyttstädning, kontorsstädning och hemstädning i Kungsängen och omnejd.',
  keywords: 'flyttstäd kungsängen, flyttstädning kungsängen, städfirma kungsängen, flyttstädning stockholm',
  openGraph: {
    title: 'Flyttstäd i Kungsängen | Professionell Städservice | Flyttella',
    description: 'Professionell flyttstädning i Kungsängen, Stockholm.',
    type: 'website',
    locale: 'sv_SE',
  },
};

export default function FlyttstadKungsangenPage() {
  return (
          ...
          <div className="max-w-4xl mx-auto">
            <div className="text-center mb-12">
              <h1 className="text-4xl md:text-6xl font-bold mb-6">
                Flyttstäd i Kungsängen
              </h1>
              <p className="text-xl md:text-2xl text-white/90 mb-8">
                Professionell flyttstädning i Kungsängen, Stockholm. Vi har erfarenhet av städning i villor, lägenheter och kontor i detta lugna område.
              </p>
            </div>
      ...
      <div className="container mx-auto px-4 py-16">
        <div className="max-w-4xl mx-auto mb-16">
          <div className="bg-white rounded-xl shadow-lg p-8 md:p-12">
            <h2 className="text-2xl md:text-3xl font-bold text-[#0F172A] mb-6">
              Professionell flyttstädning i Kungsängen, Stockholm
            </h2>
            <div className="space-y-4 text-gray-600">
              <p className="text-lg">
                Som ledande städfirma i Kungsängen har vi specialiserat oss på att erbjuda grundlig och professionell flyttstädning. 
                Kungsängen är känt för sina lugna villor, moderna lägenheter och familjevänliga miljöer som kräver noggrann städning.
              </p>
              <p className="text-lg">
                Vi förstår de specifika kraven för städning i Kungsängen - från villor med trädgårdar till moderna lägenheter. 
        ...
        <div className="text-center">
          <h2 className="text-3xl font-bold text-[#0F172A] mb-6">
            Boka din städtjänst i Kungsängen idag
          </h2>
          <p className="text-lg text-gray-600 mb-8 max-w-2xl mx-auto">
            Vi erbjuder skräddarsydda städlösningar för alla typer av bostäder i Kungsängen. 
