...
export const metadata: Metadata = {
  title: 'Flyttstäd i Åkersberga | Professionell Städservice | Flyttella',
  description: 'Professionell flyttstädning i Åkersberga, Stockholm. Vi erbjuder grundlig flyttstädning, kontorsstädning och hemstädning i Åkersberga och omnejd.',
  keywords: 'flyttstäd åkersberga, flyttstädning åkersberga, städfirma åkersberga, flyttstädning stockholm',
  openGraph: {
    title: 'Flyttstäd i Åkersberga | Professionell Städservice | Flyttella',
    description: 'Professionell flyttstädning i Åkersberga, Stockholm.',
    type: 'website',
    locale: 'sv_SE',
  },
};
          ...
          <div className="max-w-4xl mx-auto">
            <div className="text-center mb-12">
              <h1 className="text-4xl md:text-6xl font-bold mb-6">
                Flyttstäd i Åkersberga
              </h1>
              <p className="text-xl md:text-2xl text-white/90 mb-8">
                Professionell flyttstädning i Åkersberga, Stockholm. Vi har erfarenhet av städning i villor, lägenheter och kontor i detta kustnära område.
              </p>
            </div>
      ...
      <div className="container mx-auto px-4 py-16">
        <div className="max-w-4xl mx-auto mb-16">
          <div className="bg-white rounded-xl shadow-lg p-8 md:p-12">
            <h2 className="text-2xl md:text-3xl font-bold text-[#0F172A] mb-6">
              Professionell flyttstädning i Åkersberga, Stockholm
            </h2>
            <div className="space-y-4 text-gray-600">
              <p className="text-lg">
                Som ledande städfirma i Åkersberga har vi specialiserat oss på att erbjuda grundlig och professionell flyttstädning. 
                Åkersberga är känt för sina kustnära villor, moderna lägenheter och lugna bostadsområden som kräver noggrann städning.
              </p>
              <p className="text-lg">
                Vi förstår de specifika kraven för städning i Åkersberga - från kustnära villor till moderna lägenheter. 
        ...
        <div className="text-center">
          <h2 className="text-3xl font-bold text-[#0F172A] mb-6">
            Boka din städtjänst i Åkersberga idag
          </h2>
          <p className="text-lg text-gray-600 mb-8 max-w-2xl mx-auto">
            Vi erbjuder skräddarsydda städlösningar för alla typer av bostäder i Åkersberga. 
