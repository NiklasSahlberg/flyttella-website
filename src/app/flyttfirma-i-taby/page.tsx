...
export const metadata: Metadata = {
  title: 'Flyttfirma i Täby | Professionell Flyttservice | Flyttella',
  description: 'Professionell flyttfirma i Täby. Vi erbjuder flyttstädning, packning och bohagsflytt i Täby och omnejd. Erfarenhet sedan 2010.',
  keywords: 'flyttfirma täby, flyttstädning täby, packning täby, bohagsflytt täby, flyttfirma stockholm',
  openGraph: {
    title: 'Flyttfirma i Täby | Professionell Flyttservice | Flyttella',
    description: 'Professionell flyttfirma i Täby. Vi erbjuder flyttstädning, packning och bohagsflytt i Täby och omnejd.',
    type: 'website',
    locale: 'sv_SE',
  },
};

export default function FlyttfirmaTabyPage() {
  return (
          ...
          <div className="max-w-4xl mx-auto">
            <div className="text-center mb-12">
              ...
              <p className="text-xl md:text-2xl text-white/90 mb-8">
                Professionell flyttservice i Täby - från lägenheter i centrum till villor i utkanten. Vi förstår de unika utmaningarna med att flytta i Täbys familjevänliga miljö.
              </p>
            </div>
      ...
      <div className="container mx-auto px-4 py-16">
        ...
        <div className="max-w-4xl mx-auto mb-16">
          <div className="bg-white rounded-xl shadow-lg p-8 md:p-12">
            <h2 className="text-2xl md:text-3xl font-bold text-[#0F172A] mb-6">
              Professionell flyttservice i Täby
            </h2>
            <div className="space-y-4 text-gray-600">
              <p className="text-lg">
                Som ledande flyttfirma i Täby har vi specialiserat oss på att hantera alla typer av flyttar - från lägenheter i Täby Centrum till villor i utkanten. 
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8 mb-16">
          ...
          <div className="bg-white rounded-lg shadow-lg p-8">
            ...
            <ul className="space-y-3">
              {[
                "Erfarenhet med familjevänliga flyttar",
                "Hantering av barnrum och leksaker",
                "Fullständig försäkring",
                "Flexibla tider för familjer",
                "Lokal expertis i Täby",
          ...
          <div className="bg-white rounded-lg shadow-lg p-8">
            ...
            <ul className="space-y-3">
              {[
                ...
                "Familjevänlig städning",
                "Städgaranti",
                "Flexibla tider",
                "Erfaren personal i Täby",
                "Snabb service"
              ].map((item, index) => (
                <li key={index} className="flex items-start">
                  <svg className="w-5 h-5 text-[#10B981] mt-1 mr-3 flex-shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor">
          ...
          <div className="bg-white rounded-lg shadow-lg p-8">
            ...
            <ul className="space-y-3">
              {[
                "Effektiv packning för familjer",
                "Särskild omsorg för barnrum",
                "Packgaranti",
                "Säker hantering",
                "Effektiv process",
                "Erfaren personal i Täby"
        ...
        <div className="bg-gradient-to-r from-[#0F172A] to-[#10B981] rounded-lg shadow-lg p-8 text-white mb-16">
          <h2 className="text-2xl font-bold mb-6">
            Varför välja oss som din flyttfirma i Täby?
          </h2>
          <ul className="grid md:grid-cols-2 gap-4">
            {[
              "Erfarenhet med alla bostadstyper",
              "Lokalkännedom i hela Täby",
        ...
        <div className="text-center">
          <h2 className="text-3xl font-bold text-[#0F172A] mb-6">
            Boka din flytt i Täby idag
          </h2>
          <p className="text-lg text-gray-600 mb-8 max-w-2xl mx-auto">
            Vi erbjuder skräddarsydda lösningar för familjeflyttar i Täby. 
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            "@type": "LocalBusiness",
            "name": "Flyttella - Flyttfirma i Täby",
