...
export const metadata: Metadata = {
  title: 'Flyttstäd i Danderyd | Professionell Städservice | Flyttella',
  description: 'Professionell flyttstädning i Danderyd, Stockholm. Vi erbjuder grundlig flyttstädning, kontorsstädning och hemstädning i Danderyd och omnejd. Erfarenhet med städning av villor, lägenheter och kontor. Snabb service och konkurrenskraftiga priser.',
  keywords: 'flyttstäd danderyd, flyttstädning danderyd, städfirma danderyd, flyttstädning stockholm, hemstädning danderyd, kontorsstädning danderyd, städning villa, städning lägenhet',
  openGraph: {
    title: 'Flyttstäd i Danderyd | Professionell Städservice | Flyttella',
    description: 'Professionell flyttstädning i Danderyd, Stockholm. Vi erbjuder grundlig flyttstädning, kontorsstädning och hemstädning i Danderyd och omnejd.',
    type: 'website',
    locale: 'sv_SE',
  },
};

export default function FlyttstadDanderydPage() {
  return (
    <main className="min-h-screen">
          ...
          <div className="max-w-4xl mx-auto">
            <div className="text-center mb-12">
              <h1 className="text-4xl md:text-6xl font-bold mb-6">
                Flyttstäd i Danderyd
              </h1>
              <p className="text-xl md:text-2xl text-white/90 mb-8">
                Professionell flyttstädning i Danderyd, Stockholm. Vi har erfarenhet av städning i villor, lägenheter och kontor i detta exklusiva område.
              </p>
            </div>
      ...
      <div className="container mx-auto px-4 py-16">
        ...
        <div className="max-w-4xl mx-auto mb-16">
          <div className="bg-white rounded-xl shadow-lg p-8 md:p-12">
            <h2 className="text-2xl md:text-3xl font-bold text-[#0F172A] mb-6">
              Professionell flyttstädning i Danderyd, Stockholm
            </h2>
            <div className="space-y-4 text-gray-600">
              <p className="text-lg">
                Som ledande städfirma i Danderyd har vi specialiserat oss på att erbjuda grundlig och professionell flyttstädning. 
                Danderyd är känt för sina exklusiva villor, moderna lägenheter och professionella kontorsmiljöer som kräver noggrann städning.
              </p>
              <p className="text-lg">
                Vi förstår de specifika kraven för städning i Danderyd - från exklusiva villor med trädgårdar till moderna kontorslokaler. 
        ...
        {/* Danderyd Specific Features */}
        <div className="bg-white rounded-lg shadow-lg p-8 mb-16">
          <h2 className="text-2xl font-bold text-[#0F172A] mb-6">
            Varför välja oss som din städfirma i Danderyd?
          </h2>
          <div className="grid md:grid-cols-2 gap-8">
            <div>
              ...
              <ul className="space-y-2">
                {[
                  "Känner till Danderyds exklusiva områden",
                  "Erfarenhet med högkvalitativa villor",
                  "Förstår villastädernas höga standarder",
                  "Känner till Danderyd centrum och närområden",
            ...
            <div>
              ...
              <ul className="space-y-2">
                {[
                  "Städning av exklusiva villor",
                  "Kontorsstädning i Danderyd centrum",
        ...
        <div className="bg-gradient-to-r from-[#0F172A] to-[#10B981] rounded-lg shadow-lg p-8 text-white mb-16">
          ...
          <ul className="grid md:grid-cols-2 gap-4">
            {[
              "Erfarenhet med alla bostadstyper i Danderyd",
        ...
        <div className="text-center">
          <h2 className="text-3xl font-bold text-[#0F172A] mb-6">
            Boka din städtjänst i Danderyd idag
          </h2>
          <p className="text-lg text-gray-600 mb-8 max-w-2xl mx-auto">
            Vi erbjuder skräddarsydda städlösningar för alla typer av bostäder och kontor i Danderyd. 
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            "@type": "LocalBusiness",
            "name": "Flyttella - Flyttstäd i Danderyd",
            "description": "Professionell flyttstädning i Danderyd, Stockholm. Vi erbjuder flyttstädning, kontorsstädning och hemstädning.",
            "url": "https://flyttella.se/flyttstad-i-danderyd",
