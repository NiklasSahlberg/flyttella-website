            ...
            <div className="max-w-7xl mx-auto">
              <div className="grid grid-cols-3 gap-6">
                ...
                <motion.div className="relative bg-gradient-to-r from-[#0F172A] to-[#10B981] rounded-xl p-5 shadow-lg text-white flex flex-col h-full" initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.4, delay: 0.1 }}>
                  ...
                  <p className="text-sm text-gray-100 mb-4 relative">{locale === 'sv' ? 'Förbered din bostad inför visning med professionell städning.' : 'Prepare your home for viewing with professional cleaning.'}</p>
                ...
                <div className="flex flex-col md:flex-row items-center justify-center gap-3 md:gap-6">
                  <div className="md:hidden flex flex-col items-center">
                    ...
                    <div className="flex items-center justify-center gap-4 mr-4">
                      <motion.div whileHover={{ scale: 1.08 }} className="transition-transform duration-300"><Image src="/rekommenderad2026.png" alt={locale === 'sv' ? 'Rekommenderad städfirma' : 'Recommended cleaning company'} width={160} height={160} className="object-contain h-28 w-28" /></motion.div>
                  ...
                  <div className="hidden md:flex items-center justify-center gap-6">
                    <motion.div whileHover={{ scale: 1.08 }} className="transition-transform duration-300"><Image src="/rekommenderad2026.png" alt={locale === 'sv' ? 'Rekommenderad städfirma' : 'Recommended cleaning company'} width={240} height={240} className="object-contain h-52 w-52" /></motion.div>
