    ...
    <>
      ...
      <div className="relative z-20 max-w-7xl mx-auto" style={{ marginTop: '-8rem' }}>
        <motion.div
          ...
          viewport={{ once: true }}
        >
          <h3 className="text-3xl md:text-4xl font-bold text-[#0F172A] mb-6 text-center">{t('solna.experienceSection.title')}</h3>
  ...
  return (
    <main className="overflow-hidden">
      ...
      {/* Hero Section */}
        <div className="relative py-2 bg-white text-[#0F172A] overflow-hidden">
          ...
          <div className="md:hidden mx-auto px-4 pb-8">
            {selectedServiceType === 'flyttstad' ? (
              ...
              <FlyttoffertForm 
                mode="widget" 
                backgroundImage="/solna-flyttfirma.jpg" 
          ...
          <div className="md:hidden mx-auto px-4 py-6">
            <div className="bg-gradient-to-r from-[#0F172A] to-[#10B981] text-white rounded-2xl p-6 relative overflow-hidden">
              ...
              <div 
                ...
                style={{
                  backgroundImage: 'url(/solna-flyttfirma.jpg)',
                  backgroundSize: 'cover',
          ...
          <div className="relative z-40 max-w-[90rem] mx-auto px-4 md:px-8 lg:px-16">
            ...
            >
              ...
              <div className="lg:hidden mb-6">
                ...
                <h3 className="text-3xl md:text-4xl lg:text-5xl font-bold text-[#0F172A] mb-8 md:mb-12 lg:mb-16 text-center">{t('solna.about.title')}</h3>
              ...
              <div className="relative flex flex-col lg:flex-row items-stretch gap-8 md:gap-12 lg:gap-16">
                ...
                <div className="hidden lg:block space-y-8">
                  <p className="text-xl md:text-2xl text-[#0F172A] leading-relaxed">
                    {t('solna.about.desktop')}
                  </p>
                  <p className="text-xl md:text-2xl text-[#0F172A] leading-relaxed">
                    {t('solna.about.desktop2')}
                  </p>
                  <p className="text-xl md:text-2xl text-[#0F172A] leading-relaxed">
                    {t('solna.about.desktop3')}
                  </p>
                </div>
        ...
        <ReviewsWidget 
          location="Solna"
          title={t('solna.customerReviews.title')}
          subtitle={t('solna.reviews.subtitle')}
          description={t('solna.reviews.description')}
          badgeAlt={t('solna.reviews.badgeAlt')}
          arrowText={t('solna.reviews.arrowText')}
        />
              ...
              <div className="w-full">
                ...
                <div className="text-center mb-4 md:mb-8">
                  <p className="text-white text-base md:text-lg lg:text-xl max-w-4xl mx-auto mb-3 md:mb-4">
                    {t('solna.processSection.description')}
                  </p>
            </div>
          ...
          <div className="container mx-auto px-4">
            <div className="flex flex-col md:flex-row items-center gap-6 md:gap-12">
              ...
              <div className="w-full md:hidden text-center mb-4">
                <h2 className="text-2xl md:text-4xl font-extrabold text-[#0F172A] mb-3 md:mb-6">{t('solna.awards.title')}</h2>
                <p className="text-lg md:text-2xl text-gray-700 leading-relaxed">
                  {t('solna.awards.description')}
                </p>
              </div>
              ...
              <div className="hidden md:flex w-full md:w-2/5 md:order-1 text-left flex-col items-start justify-center">
                <h2 className="text-3xl md:text-4xl font-extrabold text-[#0F172A] mb-6">{t('solna.awards.title')}</h2>
        ...
        >
          <div className="container mx-auto px-4 relative z-10">
              ...
              >
                  {t('solna.servicesSection.description')}
              </motion.p>
              <motion.div
              ...
              >
                ...
                >
                  ...
                  >
                    {t('solna.servicesSection.privateServices')}
                    <motion.svg 
                      xmlns="http://www.w3.org/2000/svg" 
                      className="h-5 w-5 ml-2 group-hover:translate-x-1 transition-transform" 
                      fill="none" 
            ...
            <div className="w-full">
              <div className="text-center mb-8 md:mb-12">
                <h2 className="text-2xl md:text-4xl font-bold text-[#0F172A] mb-3 md:mb-4">
                  {t('solna.blogSection.title')}
          </h2>
                <p className="text-base md:text-lg text-gray-600 max-w-2xl mx-auto px-4">
                  {t('solna.blogSection.description')}
                </p>
              </div>
            ...
            <div className="max-w-4xl mx-auto">
              ...
              <div className="space-y-4">
                {[
                  {
                    id: "solna-1",
                    question: t('solna.faq.items.0.question'),
                    answer: t('solna.faq.items.0.answer')
                  },
                  {
                    id: "solna-2",
                    question: t('solna.faq.items.1.question'),
                    answer: t('solna.faq.items.1.answer')
                  },
                  {
                    id: "solna-3",
                    question: t('solna.faq.items.2.question'),
                    answer: t('solna.faq.items.2.answer')
                  },
                  {
                    id: "solna-4",
                    question: t('solna.faq.items.3.question'),
                    answer: t('solna.faq.items.3.answer')
                  },
                  {
                    id: "solna-5",
                    question: t('solna.faq.items.4.question'),
                    answer: t('solna.faq.items.4.answer')
                  },
                ].map((faq, index) => (
                  <motion.div
                    key={faq.id}
              ...
              <div className="text-center mt-12">
                <p className="text-lg text-gray-600 mb-6">
                  {t('solna.faqFooter.title')}
                </p>
                <Link 
                  href="/faq" 
                  className="inline-flex items-center bg-gradient-to-r from-[#0F172A] to-[#10B981] text-white px-8 py-4 rounded-full hover:opacity-90 transition-opacity font-medium group"
                >
                  {t('solna.faqFooter.linkText')}
                  <svg 
                    xmlns="http://www.w3.org/2000/svg" 
                    className="h-5 w-5 ml-2 group-hover:translate-x-1 transition-transform" 
                    fill="none" 
