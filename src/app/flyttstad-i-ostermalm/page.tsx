...
export const metadata: Metadata = {
  title: 'Flyttstäd i Östermalm | Professionell Städservice | Flyttella',
  description: 'Professionell flyttstädning i Östermalm, Stockholm. Vi erbjuder grundlig flyttstädning, kontorsstädning och hemstädning i Östermalm och omnejd.',
  keywords: 'flyttstäd östermalm, flyttstädning östermalm, städfirma östermalm, flyttstädning stockholm',
  openGraph: {
    title: 'Flyttstäd i Östermalm | Professionell Städservice | Flyttella',
    description: 'Professionell flyttstädning i Östermalm, Stockholm.',
    type: 'website',
    locale: 'sv_SE',
  },
};

export default function FlyttstadOstermalmPage() {
  return (
          ...
          <div className="max-w-4xl mx-auto">
            <div className="text-center mb-12">
              <h1 className="text-4xl md:text-6xl font-bold mb-6">
                Flyttstäd i Östermalm
              </h1>
              <p className="text-xl md:text-2xl text-white/90 mb-8">
                Professionell flyttstädning i Östermalm, Stockholm. Vi har erfarenhet av städning i exklusiva lägenheter, kontor och högkvalitativa bostäder.
              </p>
            </div>
      ...
      <div className="container mx-auto px-4 py-16">
        <div className="max-w-4xl mx-auto mb-16">
          <div className="bg-white rounded-xl shadow-lg p-8 md:p-12">
            <h2 className="text-2xl md:text-3xl font-bold text-[#0F172A] mb-6">
              Professionell flyttstädning i Östermalm, Stockholm
            </h2>
            <div className="space-y-4 text-gray-600">
              <p className="text-lg">
                Som ledande städfirma i Östermalm har vi specialiserat oss på att erbjuda grundlig och professionell flyttstädning. 
                Östermalm är Stockholms mest exklusiva område med högkvalitativa lägenheter, exklusiva kontor och eleganta bostäder som kräver noggrann städning.
              </p>
              <p className="text-lg">
                Vi förstår de specifika kraven för städning i Östermalm - från exklusiva lägenheter till högkvalitativa kontor. 
        ...
        <div className="text-center">
          <h2 className="text-3xl font-bold text-[#0F172A] mb-6">
            Boka din städtjänst i Östermalm idag
          </h2>
          <p className="text-lg text-gray-600 mb-8 max-w-2xl mx-auto">
            Vi erbjuder skräddarsydda städlösningar för alla typer av bostäder och kontor i Östermalm. 
