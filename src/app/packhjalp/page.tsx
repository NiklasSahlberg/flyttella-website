...
export default function PackhjalpPage() {
	...
	const [openFAQBarhjalp, setOpenFAQBarhjalp] = React.useState<string | null>(null);
	...
	const toggleFAQBarhjalp = (id: string) => {
		setOpenFAQBarhjalp(openFAQBarhjalp === id ? null : id);
	};

	const experienceCards = [
		{ title: t('packhjalp.experience.packhjalp'), count: t('packhjalp.experience.packhjalpCount'), description: t('packhjalp.experience.packhjalpDesc'), delay: 0 },
		{ title: t('packhjalp.experience.moves'), count: t('packhjalp.experience.movesCount'), description: t('packhjalp.experience.movesDesc'), delay: 0 },
		{ title: t('packhjalp.experience.cleanings'), count: t('packhjalp.experience.cleaningsCount'), description: t('packhjalp.experience.cleaningsDesc'), delay: 1 },
	];
    ...
    <main id="top" className="overflow-hidden">
			<div className="main-zoom">
					...
					<div className="md:hidden">
						<div className="bg-gradient-to-r from-[#0F172A] to-[#10B981] text-white py-12 relative overflow-hidden">
							...
							<div className="relative z-10 text-center px-4">
								<h1 className="text-5xl font-bold mb-6">{t('packhjalp.hero.title')}</h1>
								<p className="text-2xl text-white/90">{t('packhjalp.hero.subtitle')}</p>
							</div>
						</div>
					</div>
						...
						<div className="bg-gradient-to-r from-[#0F172A] to-[#10B981] text-white rounded-2xl p-6 md:p-10 lg:p-12 relative overflow-hidden md:min-h-[720px] lg:min-h-[780px] flex items-center">
							...
							<div className="flex flex-col-reverse md:flex-row items-center justify-between gap-16 relative z-10">
								<div className="max-w-xl w-full">
									<h1 className="text-5xl md:text-6xl font-bold mb-8">{t('packhjalp.hero.titleDesktop')}</h1>
									<p className="text-2xl md:text-3xl mb-12">{t('packhjalp.hero.subtitle')}</p>
									<p className="text-xl md:text-2xl text-white/90">{t('packhjalp.hero.description')}</p>
								</div>
								{/* Right-side CTA directly on background */}
								<div className="w-full md:w-1/2 lg:w-[40%]">
									<h3 className="text-2xl md:text-3xl font-bold text-white mb-3">{t('packhjalp.hero.ctaTitle')}</h3>
									<p className="text-white/90 mb-6 text-lg md:text-xl">{t('packhjalp.hero.ctaDescription')}</p>
									<div>
										<Link 
											href="/offert"
							...
							<div className="absolute bottom-8 left-1/2 transform -translate-x-1/2 z-10">
								...
								>
									...
									>
										<span className="text-sm font-medium mb-2">{t('packhjalp.hero.readMore')}</span>
										<motion.div
											animate={{ y: [0, 5, 0] }}
                ...
                <section id="content" className="relative py-0 md:py-16 bg-white">
                    ...
                    <div className="container mx-auto px-4">
                        <div className="max-w-7xl mx-auto relative">
							...
							>
								{([
									{ title: t('packhjalp.content.whatIsTitle'), content: t('packhjalp.content.whatIsDescription'), icon: '📦' },
									...
									{ title: t('packhjalp.content.pricingTitle'), content: (<div className="px-4 md:px-0">
											...
											<div className="my-12 md:my-16 text-left md:text-center px-4">
												<p className="text-xl md:text-2xl lg:text-3xl italic font-bold" style={{ color: '#3b82f6' }}>
													"{t('packhjalp.content.pricingTestimonial')}"
												</p>
												<p className="italic text-gray-700 mt-2">- {t('packhjalp.content.testimonialAuthor')}</p>
											</div>
										</div>), icon: '💸' },
									{ title: t('packhjalp.content.includesTitle'), content: (<p className="px-4 md:px-0 text-gray-700 leading-relaxed text-lg md:text-xl lg:text-2xl">{t('packhjalp.content.includesDescription')}</p>), icon: '✅' },
									...
									{ title: t('packhjalp.content.bookingTitle'), content: (<div className="px-4 md:px-0"><p className="text-gray-700 leading-relaxed text-lg md:text-xl lg:text-2xl">{t('packhjalp.content.bookingDescription')}</p></div>), icon: '📞' },
				...
				<section className="relative overflow-hidden py-16 md:py-24 lg:py-32">
					...
					<div className="relative z-10 max-w-[90rem] mx-auto px-4 md:px-8 lg:px-16 om-oss-container">
						...
						>
							...
							<h3 className="text-3xl md:text-4xl lg:text-5xl font-bold text-[#0F172A] mb-8 md:mb-12 lg:mb-16 text-center om-oss-title">{t('packhjalp.about.title')}</h3>
								...
								>
									...
									<div className="hidden lg:block space-y-8">
										<p className="text-xl md:text-2xl text-[#0F172A] leading-relaxed">
											{t('packhjalp.about.description1')}
										</p>
										<p className="text-xl md:text-2xl text-[#0F172A] leading-relaxed">
											{t('packhjalp.about.description2')}
										</p>
										<p className="text-xl md:text-2xl text-[#0F172A] leading-relaxed">
											{t('packhjalp.about.description3')}
										</p>
									</div>
										...
										{showFullAboutText && (
											...
											>
												...
												>
													...
													>
														{t('packhjalp.about.readMoreAbout')}
														<svg 
															xmlns="http://www.w3.org/2000/svg" 
															className="h-4 w-4 ml-2 group-hover:translate-x-1 transition-transform" 
															fill="none" 
              ...
              <Link 
				...
				<ReviewsWidget 
					title={t('packhjalp.reviews.title')}
					subtitle={t('packhjalp.reviews.subtitle')}
					description={t('packhjalp.reviews.description')}
				/>
							...
							<div className="flex items-center gap-3 md:gap-4 relative z-10 mb-3 md:mb-4">
								...
								<div>
									<h3 className="text-xl md:text-3xl font-bold text-white mb-1 md:mb-2">
										{t('packhjalp.cta.title')}
									</h3>
									<p className="text-base md:text-lg text-gray-100">
										{t('packhjalp.cta.subtitle')}
									</p>
								</div>
							</div>
						...
						<div className="max-w-7xl mx-auto">
							...
							>
								...
								<div className="flex items-center gap-4 mb-6 md:mb-8 relative">
									...
									<h3 className="text-4xl md:text-5xl font-bold text-white">
										{t('packhjalp.services.flyttstadning.title')}
									</h3>
								</div>
								<p className="text-lg md:text-xl text-gray-100 mb-6 md:mb-8 relative">
									{t('packhjalp.services.flyttstadning.description')}
								</p>
								<p className="hidden md:block text-lg text-gray-100 mb-8 relative">
									{t('packhjalp.services.flyttstadning.descriptionExtended')}
								</p>
							...
							>
								...
								<div className="flex items-center gap-4 mb-6 md:mb-8 relative">
									<span className="text-4xl md:text-6xl">🚚</span>
									<h3 className="text-4xl md:text-5xl font-bold text-white">
										{t('packhjalp.services.bohagsflytt.title')}
									</h3>
								</div>
								<p className="text-lg md:text-xl text-gray-100 mb-6 md:mb-8 relative">
									{t('packhjalp.services.bohagsflytt.description')}
								</p>
								<p className="hidden md:block text-lg text-gray-100 mb-8 relative">
							...
							>
								...
								<div className="flex items-center gap-4 mb-6 md:mb-8 relative">
									<span className="text-4xl md:text-6xl">🏬</span>
									<h3 className="text-4xl md:text-5xl font-bold text-white">
										{t('packhjalp.services.magasinering.title')}
									</h3>
								</div>
								<p className="text-lg md:text-xl text-gray-100 mb-1 md:mb-8 relative">
								{t('packhjalp.services.magasinering.description')}
								</p>
								<p className="md:hidden text-lg text-gray-100 mb-6 md:mb-0 relative">
									{t('packhjalp.services.magasinering.descriptionMobile')}
								</p>
								<p className="hidden md:block text-lg text-gray-100 mb-8 relative">
									{t('packhjalp.services.magasinering.descriptionExtended')}
								</p>
								<div className="mt-auto relative">
									<motion.div 
										whileHover={{ scale: 1.05 }} 
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
              ...
              >
                ...
                <div className="flex items-center gap-2 mb-3 relative">
                  ...
                  <h3 className="text-lg font-bold text-white">{t('packhjalp.sidebar.montering.title')}</h3>
                </div>
                <p className="text-xs text-gray-100 mb-4 relative">{t('packhjalp.sidebar.montering.description')}</p>
                <div className="mt-auto relative">
                  <Link href="/montering" className="inline-flex items-center bg-white text-[#0F172A] px-3 py-2 rounded-full hover:bg-opacity-90 transition-opacity font-medium group text-xs">
                    {t('packhjalp.sidebar.montering.readMore')}
                    <svg xmlns="http://www.w3.org/2000/svg" className="h-3 w-3 ml-1 group-hover:translate-x-1 transition-transform" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 5l7 7-7 7" />
                    </svg>
                  </Link>
              ...
              >
                ...
                <div className="flex items-center gap-2 mb-3 relative">
                  <span className="text-2xl">🎹</span>
                  <h3 className="text-lg font-bold text-white">{t('packhjalp.sidebar.tunglyft.title')}</h3>
                </div>
                <p className="text-xs text-gray-100 mb-4 relative">{t('packhjalp.sidebar.tunglyft.description')}</p>
                <div className="mt-auto relative">
                  <Link href="/piano-tunglyft" className="inline-flex items-center bg-white text-[#0F172A] px-3 py-2 rounded-full hover:bg-opacity-90 transition-opacity font-medium group text-xs">
                    {t('packhjalp.sidebar.tunglyft.readMore')}
                    <svg xmlns="http://www.w3.org/2000/svg" className="h-3 w-3 ml-1 group-hover:translate-x-1 transition-transform" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 5l7 7-7 7" />
                    </svg>
                  </Link>
					...
					<div className="container mx-auto px-4 relative z-10">
						<div className="max-w-3xl mx-auto text-center">
							<motion.h2 
								...
								id="upptack-tjanster"
							>
								{t('packhjalp.services.allServices.title')}
							</motion.h2>
							<motion.p 
							...
							>
								{t('packhjalp.services.allServices.description')}
							</motion.p>
							<motion.div
							...
							>
								...
								>
									...
									>
										{t('packhjalp.services.allServices.movingServices')}
										<motion.svg 
											xmlns="http://www.w3.org/2000/svg" 
											className="h-5 w-5 ml-2 group-hover:translate-x-1 transition-transform" 
											fill="none" 
								...
								>
									<Link 
										...
										className="inline-flex items-center bg-gradient-to-r from-[#0F172A] to-[#10B981] text-white px-8 py-4 rounded-full hover:opacity-90 transition-opacity font-medium group"
									>
										{t('packhjalp.services.allServices.cleaningServices')}
										<motion.svg 
											xmlns="http://www.w3.org/2000/svg" 
											className="h-5 w-5 ml-2 group-hover:translate-x-1 transition-transform" 
											fill="none" 
				...
				>
					...
					<div className="relative z-10 max-w-7xl mx-auto" style={{ marginTop: '-8rem' }}>
						<motion.div initial="initial" whileInView="animate" viewport={{ once: true }}>
							<h3 className="text-3xl md:text-4xl font-bold text-[#0F172A] mb-6 text-center">{t('packhjalp.experience.title')}</h3>
							...
							<div className="mt-8 flex flex-col items-center justify-center gap-4">
								...
								<motion.div
									...
									transition={{ duration: 0.8 }}
								>
									<h4 className="text-3xl md:text-4xl font-bold text-[#0F172A] mb-4">{t('packhjalp.experience.localExperienceTitle')}</h4>
									<p className="text-xl md:text-2xl text-[#0F172A] leading-relaxed mb-4 px-4 md:px-8">
										{t('packhjalp.experience.localExperienceDesc1')}
									</p>
									{!showFullExperienceText && (
										<div className="md:hidden mb-3">
											...
											>
												{t('packhjalp.experience.readMore')}
												<svg
													xmlns="http://www.w3.org/2000/svg"
													className="h-4 w-4 ml-2 group-hover:translate-x-1 transition-transform"
													fill="none"
									...
									{showFullExperienceText && (
										...
										>
											<p className="text-xl md:text-2xl text-[#0F172A] leading-relaxed">
												{t('packhjalp.experience.localExperienceDesc2')}
											</p>
										</motion.div>
									)}
									...
									<div className="flex items-center justify-center gap-4 mr-6">
										<motion.div whileHover={{ scale: 1.08 }} className="transition-transform duration-300">
											<Image
												...
												alt="Rekommenderad bärhjälpsfirma - Flyttella"
												width={160}
												height={160}
										...
										<motion.div whileHover={{ scale: 1.08 }} className="transition-transform duration-300">
											<Image
												...
												alt="Top 10 bärhjälpsfirma - Flyttella"
												width={180}
												height={180}
												className="object-contain h-28 w-28"
												priority={false}
				...
				{/* Process Section - SEO optimized for bärhjälp */}
							...
							<div className="w-full">
								...
								<div className="text-center mb-6 md:mb-8 hidden md:block">
									<p className="text-white text-base md:text-lg lg:text-xl max-w-4xl mx-auto mb-4 md:mb-6 leading-relaxed">
										{t('packhjalp.process.description')}
									</p>
								</div>
								...
								<div className="text-center mb-4 md:mb-8">
									<p className="text-white text-base md:text-lg lg:text-xl max-w-4xl mx-auto mb-3 md:mb-4">
										{t('packhjalp.process.pricingDescription')}
                  </p>
                </div>

								{/* Process Flow Section */}
								<div className="mb-4 md:mb-8">
									<h3 className="text-xl md:text-2xl lg:text-3xl font-bold text-white mb-4 md:mb-8 text-center">{t('packhjalp.process.howItWorks')}</h3>
									<div className="relative w-full">
										...
										<div className="grid grid-cols-2 md:grid-cols-6 gap-1 md:gap-3 w-full items-stretch">
											{[
												{
													icon: <FillFormLottie />,
													title: t('packhjalp.process.steps.0.title'),
													description: t('packhjalp.process.steps.0.description'),
													textClass: ""
												},
												{
													icon: <FastLottie />,
													title: t('packhjalp.process.steps.1.title'),
													description: t('packhjalp.process.steps.1.description'),
													textClass: ""
												},
												{
													icon: <div className="ml-4 md:ml-6"><SignFormLottie /></div>,
													title: t('packhjalp.process.steps.2.title'),
													description: t('packhjalp.process.steps.2.description'),
													containerClass: "md:-mt-6",
													textClass: ""
												},
												{
													icon: <div className="md:ml-3 md:mt-8"><PhoneCallLottie /></div>,
													title: t('packhjalp.process.steps.3.title'),
													description: t('packhjalp.process.steps.3.description'),
													containerClass: "md:-mt-7",
													textClass: ""
												},
												{
													icon: <div className="md:mr-3"><MovingTruckLottie /></div>,
													title: t('packhjalp.process.steps.4.title'),
													description: t('packhjalp.process.steps.4.description'),
													containerClass: "md:-mt-14",
													textClass: "md:-mt-8",
												},
												{
													icon: <div className="md:mt-0"><HappyCustomerLottie /></div>,
													title: t('packhjalp.process.steps.5.title'),
													description: t('packhjalp.process.steps.5.description'),
													containerClass: "md:-mt-6",
													textClass: ""
												}
											].map((step, index) => (
						...
						<div className="w-full">
							<div className="text-center mb-8 md:mb-12">
								<h2 className="text-2xl md:text-4xl font-bold text-[#0F172A] mb-3 md:mb-4">
									{t('packhjalp.blog.title')}
								</h2>
								<p className="text-lg md:text-xl text-gray-600 max-w-2xl mx-auto px-4">
									{t('packhjalp.blog.subtitle')}
								</p>
							</div>
							<div className="max-w-6xl mx-auto">
								<div className="grid md:grid-cols-1 gap-4 md:gap-2">
									<motion.div 
										className="bg-white rounded-2xl shadow-lg overflow-hidden max-h-[400px]"
										initial={{ opacity: 0, y: 20 }}
										whileInView={{ opacity: 1, y: 0 }}
											...
											<div className="w-full md:w-2/3 p-4 md:p-6">
												<div className="flex flex-col sm:flex-row sm:items-center mb-3 md:mb-4 space-y-2 sm:space-y-0">
													<span className="bg-gradient-to-r from-[#0F172A] to-[#10B981] text-white px-3 py-1 md:px-4 md:py-2 rounded-full text-sm md:text-base font-medium w-fit">
														{t('packhjalp.blog.category')}
													</span>
													<span className="text-gray-500 text-sm md:text-base sm:ml-4">{t('packhjalp.blog.readTime')}</span>
												</div>
												<h3 className="text-xl md:text-3xl font-bold text-[#0F172A] mb-4 md:mb-6 leading-tight">
													{t('packhjalp.blog.postTitle')}
												</h3>
												<p className="text-gray-600 text-base md:text-lg leading-relaxed mb-4 md:mb-6">
													{t('packhjalp.blog.postDescription')}
												</p>
				...
				{/* FAQ Section: Vanliga frågor om bärhjälp */}
				<section className="py-20 bg-white">
					<script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
						...
						'mainEntity': [
							{
								'@type': 'Question',
								'name': 'Vad är bärhjälp?',
								'acceptedAnswer': {
									'@type': 'Answer',
									'text': 'Bärhjälp innebär att få hjälp med att bära och flytta tunga föremål som möbler, flyttkartonger och andra saker. Detta kan vara vid flytt, renovering eller när du behöver hjälp med tunglyft.'
								}
							},
							{
								'@type': 'Question',
								'name': 'Hur lång tid tar bärhjälp?',
								'acceptedAnswer': {
									'@type': 'Answer',
									'text': 'Tiden beror på mängden föremål, tillgänglighet och eventuella tilläggstjänster. En normal bärhjälp tar oftast 1-3 timmar, men större projekt kan ta en hel dag.'
								}
							},
							{
								'@type': 'Question',
								'name': 'Vad kostar bärhjälp?',
								'acceptedAnswer': {
									'@type': 'Answer',
									'text': 'Priset varierar beroende på mängd föremål, typ av möbler, tillgänglighet och transportavstånd. Vi ger alltid en fast prisoffert utan dolda avgifter.'
								}
							},
							{
								'@type': 'Question',
								'name': 'Kan ni hantera tunga föremål som piano?',
								'acceptedAnswer': {
									'@type': 'Answer',
									'text': 'Ja, vi har erfarenhet av att hantera alla typer av tunga föremål inklusive piano, kassaskåp och stora möbler. Vi använder specialutrustning och följer säkerhetsriktlinjer.'
								}
							},
							{
								'@type': 'Question',
								'name': 'Behöver jag vara hemma under bärhjälpen?',
								'acceptedAnswer': {
									'@type': 'Answer',
									'text': 'Nej, du behöver inte vara hemma. Vi kan utföra bärhjälpen på egen hand efter att vi kommit överens om vad som ska flyttas och var.'
								}
							}
						]
					})}} />
					<div className="container mx-auto px-4">
						<div className="max-w-4xl mx-auto">
							<h2 className="text-3xl md:text-4xl font-bold text-[#0F172A] mb-12 text-center">
								{t('packhjalp.faq.title')}
							</h2>
							<div className="space-y-4">
								{[
									{
										id: "packhjalp-1",
										question: t('packhjalp.faq.questions.0.question'),
										answer: t('packhjalp.faq.questions.0.answer')
									},
									{
										id: "packhjalp-2",
										question: t('packhjalp.faq.questions.1.question'),
										answer: t('packhjalp.faq.questions.1.answer')
									},
									{
										id: "packhjalp-3",
										question: t('packhjalp.faq.questions.2.question'),
										answer: t('packhjalp.faq.questions.2.answer')
									},
									{
										id: "packhjalp-4",
										question: t('packhjalp.faq.questions.3.question'),
										answer: t('packhjalp.faq.questions.3.answer')
									}
								].map((faq, index) => (
									<motion.div
										key={faq.id}
									...
									>
										<button
											onClick={() => toggleFAQBarhjalp(faq.id)}
										...
										>
											...
											<motion.div
												animate={{ rotate: openFAQBarhjalp === faq.id ? 180 : 0 }}
										...
										<motion.div
											initial={false}
											animate={{
												height: openFAQBarhjalp === faq.id ? "auto" : 0,
												opacity: openFAQBarhjalp === faq.id ? 1 : 0
											}}
											transition={{
					...
					<div className="text-center mt-12">
						<p className="text-lg text-gray-600 mb-6">
							{t('packhjalp.faq.moreQuestions')}
              </p>
              <Link 
							href="/faq" 
							className="inline-flex items-center bg-gradient-to-r from-[#0F172A] to-[#10B981] text-white px-8 py-4 rounded-full hover:opacity-90 transition-opacity font-medium group"
						>
							{t('packhjalp.faq.allFaq')}
							<svg 
								xmlns="http://www.w3.org/2000/svg" 
								className="h-5 w-5 ml-2 group-hover:translate-x-1 transition-transform" 
								fill="none" 
