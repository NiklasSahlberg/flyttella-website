    ...
    <main id="top" className="overflow-hidden">
      <div className="main-zoom">
          ...
          <div className="container mx-auto px-4">
            <div className="max-w-6xl mx-auto relative">
              ...
              {([
                ...
                { title: '', content: (<div className="w-full max-w-6xl mx-auto flex justify-center my-12"><img src="/packing_tips.jpg" alt="Utlandsflytt tjänster" className="w-full h-80 md:h-96 rounded-lg shadow-lg object-cover" /></div>), icon: '' },
                { title: 'Hur bokar jag utlandsflytt?', content: (<p className="text-gray-700 leading-relaxed px-4 text-lg md:text-xl lg:text-2xl text-left md:text-center mb-8 md:mb-12">Boka via formuläret – ange adress, volym och destination. Du får pris direkt och kan bekräfta digitalt. Vi kontaktar dig samma dag eller nästkommande vardag för att stämma av detaljer, önskade datum och eventuella tillval. RUT gäller inte för flytt men vi erbjuder paketlösningar för bästa pris.</p>), icon: '📅' },
        ...
        <section className="pt-0 pb-4 bg-white">
          ...
          {/* Service Cards Section - Våra andra huvudtjänster */}
            ...
            <div className="max-w-7xl mx-auto">
              ...
              <div className="grid grid-cols-1 gap-12">
                ...
                <motion.div className="relative bg-gradient-to-r from-[#0F172A] to-[#10B981] rounded-xl p-8 md:p-12 shadow-lg text-white flex flex-col h-full md:min-h-[340px]" initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.5, delay: 0.1 }}>
                  <motion.div className="absolute inset-0 opacity-10 pointer-events-none" initial={{ backgroundPosition: '0% 0%' }} animate={{ backgroundPosition: ['0% 0%', '100% 100%'] }} transition={{ duration: 20, repeat: Infinity, repeatType: 'reverse' }} style={{ backgroundImage: 'radial-gradient(circle, #fff 1px, transparent 1px)', backgroundSize: '20px 20px' }} />
                  <div className="flex items-center gap-4 mb-6 md:mb-8 relative"><span className="text-4xl md:text-6xl">🏢</span><h3 className="text-4xl md:text-5xl font-bold text-white">Magasinering</h3></div>
                  <p className="text-lg md:text-xl text-gray-100 mb-6 md:mb-8 relative">Säker magasinering av dina tillhörigheter – flexibla lösningar för kort och lång tid.</p>
                  <p className="hidden md:block text-lg text-gray-100 mb-8 relative">Behöver du lagra bohag mellan uppsägning och inflyttning? Vi erbjuder säkra magasin och kan hjälpa till med hämtning och återleverans när du är redo.</p>
                  <div className="mt-auto relative"><motion.div whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.95 }} className="inline-block"><Link href="/magasinering" className="inline-flex items-center bg-white text-[#0F172A] px-6 py-3 md:px-8 md:py-4 rounded-full hover:bg-opacity-90 transition-opacity font-medium group md:text-lg">Läs mer<svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 md:h-6 md:w-6 ml-2 group-hover:translate-x-1 transition-transform" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 5l7 7-7 7" /></svg></Link></motion.div></div>
                </motion.div>
                ...
                <motion.div className="relative bg-gradient-to-r from-[#0F172A] to-[#10B981] rounded-xl p-8 md:p-12 shadow-lg text-white flex flex-col h-full md:min-h-[340px]" initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.5, delay: 0.2 }}>
                  <motion.div className="absolute inset-0 opacity-10 pointer-events-none" initial={{ backgroundPosition: '0% 0%' }} animate={{ backgroundPosition: ['0% 0%', '100% 100%'] }} transition={{ duration: 20, repeat: Infinity, repeatType: 'reverse' }} style={{ backgroundImage: 'radial-gradient(circle, #fff 1px, transparent 1px)', backgroundSize: '20px 20px' }} />
                  <div className="flex items-center gap-4 mb-6 md:mb-8 relative"><span className="text-4xl md:text-6xl">📦</span><h3 className="text-4xl md:text-5xl font-bold text-white">Packhjälp</h3></div>
                  ...
                  <div className="mt-auto relative"><motion.div whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.95 }} className="inline-block"><Link href="/barhjalp" className="inline-flex items-center bg-white text-[#0F172A] px-6 py-3 md:px-8 md:py-4 rounded-full hover:bg-opacity-90 transition-opacity font-medium group md:text-lg">Läs mer<svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 md:h-6 md:w-6 ml-2 group-hover:translate-x-1 transition-transform" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 5l7 7-7 7" /></svg></Link></motion.div></div>
                </motion.div>
              </div>
            </div>
          </div>
        ...
        <section className="py-8 md:py-20 bg-gray-50">
                  ...
                  <div className={`md:block ${expandedTipSection === 'efter' ? 'block' : 'hidden'}`}>
                    <div className="grid md:grid-cols-2 gap-8 max-w-4xl mx-auto">
                      <TipCard
                        ...
                        content={
                          <ul className="list-disc pl-5 space-y-2">
                            <li>Packa upp rum för rum.</li>
                            <li>Montera upp belysning och gardiner.</li>
                            <li>Återvinn packmaterial.</li>
                            <li>Uppdatera adress där det behövs.</li>
                          </ul>
                        }
                      />
                      <TipCard
                        ...
                        imageSrc="/godtid.jpg"
                        imageAlt="Dokumentation"
                        objectPosition="object-[center_30%]"
                        content={
                          <ul className="list-disc pl-5 space-y-2">
                            <li>Kontrollera att allt är levererat.</li>
                            <li>Fotografera ev. skador och meddela omgående.</li>
                            <li>Gå igenom checklistan.</li>
                            <li>Planera återvinning och städning vid behov.</li>
                          </ul>
                        }
                      />
                    </div>
         ...
         {/* CTA: Redo att börja din flytt? (after Tips) */}
          ...
          <div className="mx-auto px-4">
            ...
            >
              ...
              <div className="flex items-center gap-3 md:gap-4 relative z-10 mb-3 md:mb-4">
                ...
                <div>
                  <h3 className="text-xl md:text-3xl font-bold text-white mb-1 md:mb-2">Redo att börja din utlandsflytt?</h3>
                  <p className="text-base md:text-lg text-gray-100">Få en snabb och gratis offert</p>
                </div>
              </div>
              <div className="relative z-10">
                <motion.div whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.95 }} className="inline-block">
                  <Link href="#top" className="inline-flex items-center bg-white text-[#0F172A] px-5 py-2.5 md:px-6 md:py-3 rounded-full hover:bg-opacity-90 transition-opacity font-medium group text-sm md:text-base">
                    Få gratis offert
                    ...
                    <div className="grid grid-cols-2 md:grid-cols-6 gap-1 md:gap-3 w-full items-stretch">
                      {[
                        ...
                        >
                          ...
                          <div className={`${(step as any).containerClass || ''} w-full flex flex-col items-center justify-center`}>
                            <div className="mb-1 md:mb-2 h-16 md:h-auto flex items-center justify-center">{(step as any).icon}</div>
                            <div className={`flex flex-col items-center justify-center w-full ${(step as any).textClass || ''}`}>
                              <h4 className="text-white font-semibold text-sm md:text-base lg:text-lg mb-1 text-center w-full">{(step as any).title}</h4>
                              <p className="text-white/80 text-xs md:text-sm lg:text-base text-center w-full">{(step as any).description}</p>
                            </div>
                          </div>
                        </motion.div>
                      ))}
