              ...
              <div className="mt-8 flex flex-col items-center justify-center gap-4">
                ...
                <div className="flex flex-col md:flex-row items-center justify-center gap-3 md:gap-6">
                  <div className="md:hidden flex flex-col items-center">
                    ...
                    <div className="flex items-center justify-center gap-4 mr-4">
                      <motion.div whileHover={{ scale: 1.08 }} className="transition-transform duration-300">
                        <Image src="/rekommenderad2026.png" alt="Recommended cleaning company" width={160} height={160} className="object-contain h-28 w-28" />
                      </motion.div>
                      <motion.div whileHover={{ scale: 1.08 }} className="transition-transform duration-300">
                  ...
                  <div className="hidden md:flex items-center justify-center gap-6">
                    <motion.div whileHover={{ scale: 1.08 }} className="transition-transform duration-300">
                      <Image src="/rekommenderad2026.png" alt="Recommended cleaning company" width={240} height={240} className="object-contain h-52 w-52" />
                    </motion.div>
                    <motion.div whileHover={{ scale: 1.08 }} className="transition-transform duration-300">
