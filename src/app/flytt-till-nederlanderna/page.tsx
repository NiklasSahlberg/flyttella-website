            ...
            <motion.div initial="initial" whileInView="animate" viewport={{ once: true }}>
              ...
              <div className="mt-6 md:mt-8 flex flex-col items-center justify-center gap-4">
                ...
                <div className="hidden md:flex items-center justify-center gap-6">
                  <motion.div whileHover={{ scale: 1.08 }} className="transition-transform duration-300">
                    <Image src="/recommendedcompany2.png" alt="Rekommenderad flyttfirma till Nederländerna - Flyttella" width={240} height={240} className="object-contain h-56 w-56" priority={false} />
                  </motion.div>
                  <motion.div whileHover={{ scale: 1.08 }} className="transition-transform duration-300">
          ...
          <div className="container mx-auto px-4">
            <div className="flex flex-col md:flex-row items-center gap-12">
              <div className="w-full md:w-3/5 flex justify-center">
                <Image src="/awards_no_bg.png" alt={t('nederlanderna.awards.imageAlt')} width={1200} height={600} className="object-contain w-full h-auto max-w-3xl" priority />
              </div>
