...
export default function PianoTunglyftPage() {
	...
	const experienceCards = [
		{ title: t('pianoTunglyft.experience.tunglyft'), count: t('pianoTunglyft.experience.tunglyftCount'), description: t('pianoTunglyft.experience.tunglyftDesc'), delay: 0 },
		{ title: t('pianoTunglyft.experience.moves'), count: t('pianoTunglyft.experience.movesCount'), description: t('pianoTunglyft.experience.movesDesc'), delay: 0 },
		{ title: t('pianoTunglyft.experience.cleanings'), count: t('pianoTunglyft.experience.cleaningsCount'), description: t('pianoTunglyft.experience.cleaningsDesc'), delay: 1 },
	];
		...
		<main id="top" className="overflow-hidden">
					...
					<div className="md:hidden">
						<div className="bg-gradient-to-r from-[#0F172A] to-[#10B981] text-white py-12 relative overflow-hidden">
							...
							<div className="relative z-10 text-center px-4">
								<h1 className="text-5xl font-bold mb-6">{t('pianoTunglyft.hero.title')}</h1>
								<p className="text-2xl text-white/90">{t('pianoTunglyft.hero.subtitle')}</p>
            </div>
          </div>
        </div>
						...
						<div className="bg-gradient-to-r from-[#0F172A] to-[#10B981] text-white rounded-2xl p-6 md:p-10 lg:p-12 relative overflow-hidden md:min-h-[720px] lg:min-h-[780px] flex items-center">
							...
							<div className="flex flex-col-reverse md:flex-row items-center justify-between gap-16 relative z-10">
								<div className="max-w-xl w-full">
									<h1 className="text-5xl md:text-6xl font-bold mb-8">{t('pianoTunglyft.hero.title')} i Stockholm</h1>
									<p className="text-2xl md:text-3xl mb-12">{t('pianoTunglyft.hero.subtitle')}</p>
									<p className="text-xl md:text-2xl text-white/90">{t('pianoTunglyft.hero.description')}</p>
                </div>
            ...
            <div className="absolute bottom-8 left-1/2 transform -translate-x-1/2 z-10">
              ...
              >
                ...
                >
                  <span className="text-sm font-medium mb-2">{t('pianoTunglyft.hero.readMore')}</span>
                  <motion.div
                    animate={{ y: [0, 5, 0] }}
                ...
                <section id="content" className="relative py-0 md:py-16 bg-white">
                    ...
                    <div className="hidden lg:block absolute right-0 top-[20rem] w-72">
                        <div className="flex flex-col gap-4">
                            ...
                            />
                            <div className="bg-gradient-to-r from-[#0F172A] to-[#10B981] rounded-xl p-6 shadow-lg text-white flex flex-col mt-40">
                                ...
                                <p className="text-sm text-gray-100 mb-4 relative">{locale === 'sv' ? 'Säker förvaring av dina ägodelar i våra moderna lagerlokaler med övervakning och försäkring.' : 'Secure storage for your belongings in modern, monitored and insured facilities.'}</p>
                            ...
                            <div className="bg-gradient-to-r from-[#0F172A] to-[#10B981] rounded-xl p-6 shadow-lg text-white flex flex-col">
                                ...
                                <p className="text-sm text-gray-100 mb-4 relative">{locale === 'sv' ? 'Professionell bärhjälp för tunga och otympliga föremål. Vi hjälper dig att flytta det som kräver extra kraft och kunskap.' : 'Professional carrying help for heavy and bulky items. We help move items requiring extra strength and expertise.'}</p>
					...
					<div className="container mx-auto px-4">
                        <div className="max-w-6xl mx-auto relative content-with-sidebar content-narrow">
							...
							>
								{([
									{ title: t('pianoTunglyft.content.whatIsTitle'), content: t('pianoTunglyft.content.whatIsDescription'), icon: '🎹' },
									{ title: '', content: (<div className="w-full max-w-6xl mx-auto flex justify-center my-8 md:my-12"><Image src="/piano_tunglyft.png" alt="Piano och tunglyft i Stockholm" width={1200} height={400} className="w-full h-64 md:h-80 lg:h-96 rounded-lg shadow-lg object-cover" style={{ objectPosition: 'center 40%' }} sizes="(max-width: 768px) 100vw, (max-width: 1200px) 80vw, 60vw" /></div>), icon: '' },
									{ title: t('pianoTunglyft.content.pricingTitle'), content: (<div className="px-4 md:px-0">
											<p className="text-gray-700 leading-relaxed text-lg md:text-xl lg:text-2xl mb-4">{t('pianoTunglyft.content.pricingDescription1')}</p>
											<p className="text-gray-700 leading-relaxed text-lg md:text-xl lg:text-2xl">{t('pianoTunglyft.content.pricingDescription2')} <Link href="/kontakt?scroll=message&service=piano" className="text-[#10B981] hover:text-[#059669] underline font-medium transition-colors duration-300">{t('common.contactUs')}</Link>.</p>
											...
											<div className="my-12 md:my-16 text-left md:text-center px-4">
												<p className="text-xl md:text-2xl lg:text-3xl italic font-bold" style={{ color: '#3b82f6' }}>
													{t('pianoTunglyft.content.pricingTestimonial')}
												</p>
												<p className="italic text-gray-700 mt-2">- {t('pianoTunglyft.content.testimonialAuthor')}</p>
											</div>
										</div>), icon: '💸' },
									{ title: t('pianoTunglyft.content.includesTitle'), content: (<p className="px-4 md:px-0 text-gray-700 leading-relaxed text-lg md:text-xl lg:text-2xl">{t('pianoTunglyft.content.includesDescription')}</p>), icon: '✅' },
									{ title: '', content: (<div className="w-full max-w-6xl mx-auto flex justify-center my-8 md:my-12"><Image src="/intro_picture.jpg" alt="Tips för piano och tunglyft" width={1200} height={400} className="w-full h-64 md:h-80 lg:h-96 rounded-lg shadow-lg object-cover" sizes="(max-width: 768px) 100vw, (max-width: 1200px) 80vw, 60vw" /></div>), icon: '' },
									{ title: t('pianoTunglyft.content.bookingTitle'), content: (<div className="px-4 md:px-0"><p className="text-gray-700 leading-relaxed text-lg md:text-xl lg:text-2xl">{t('pianoTunglyft.content.bookingDescription')}</p></div>), icon: '📞' },
				...
				<section className="relative overflow-hidden py-16 md:py-24 lg:py-32">
					...
					<div className="relative z-10 max-w-[90rem] mx-auto px-8 md:px-8 lg:px-16 om-oss-container">
						...
						>
							...
							<h3 className="text-3xl md:text-4xl lg:text-5xl font-bold text-[#0F172A] mb-8 md:mb-12 lg:mb-16 text-center om-oss-title">{t('pianoTunglyft.about.title')}</h3>
								...
								>
									...
									<div className="hidden lg:block space-y-8">
										<p className="text-xl md:text-2xl text-[#0F172A] leading-relaxed">
											{t('pianoTunglyft.about.description1')}
										</p>
										<p className="text-xl md:text-2xl text-[#0F172A] leading-relaxed">
											{t('pianoTunglyft.about.description2')}
										</p>
										<p className="text-xl md:text-2xl text-[#0F172A] leading-relaxed">
											{t('pianoTunglyft.about.description3')}
										</p>
									</div>
									...
									<div className="lg:hidden space-y-4">
										...
										{!showFullAboutText && (
											...
											>
												{t('pianoTunglyft.about.readMore')}
												<svg 
													xmlns="http://www.w3.org/2000/svg" 
													className="h-5 w-5 ml-2 group-hover:translate-x-1 transition-transform" 
													fill="none" 
										...
										{showFullAboutText && (
											...
											>
												...
												>
													...
													>
														{t('pianoTunglyft.about.readMoreAbout')}
														<svg 
															xmlns="http://www.w3.org/2000/svg" 
															className="h-5 w-5 ml-2 group-hover:translate-x-1 transition-transform" 
															fill="none" 
          ...
          <Link 
				...
				<ReviewsWidget 
					title={t('pianoTunglyft.reviews.title')}
					subtitle={t('pianoTunglyft.reviews.subtitle')}
					description={t('pianoTunglyft.reviews.description')}
				/>
							...
							<div className="flex items-center gap-3 md:gap-4 relative z-10 mb-3 md:mb-4">
								...
								<div>
									<h3 className="text-xl md:text-3xl font-bold text-white mb-1 md:mb-2">
										{t('pianoTunglyft.cta.title')}
									</h3>
									<p className="text-base md:text-lg text-gray-100">
										{t('pianoTunglyft.cta.subtitle')}
									</p>
        </div>
							</div>
					...
					<div className="container mx-auto px-4">
						<div className="max-w-7xl mx-auto">
							<h2 className="text-3xl md:text-4xl font-bold text-[#0F172A] mb-12 text-center">
								{t('pianoTunglyft.services.title')}
							</h2>
							...
							>
								...
								<div className="flex items-center gap-4 mb-6 md:mb-8 relative">
									...
									<h3 className="text-4xl md:text-5xl font-bold text-white">
										{t('pianoTunglyft.services.flyttstadning.title')}
									</h3>
								</div>
								<p className="text-lg md:text-xl text-gray-100 mb-6 md:mb-8 relative">
									{t('pianoTunglyft.services.flyttstadning.description')}
								</p>
								<p className="hidden md:block text-lg text-gray-100 mb-8 relative">
									{t('pianoTunglyft.services.flyttstadning.descriptionExtended')}
								</p>
							...
							>
								...
								<div className="flex items-center gap-4 mb-6 md:mb-8 relative">
									<span className="text-4xl md:text-6xl">🚚</span>
									<h3 className="text-4xl md:text-5xl font-bold text-white">
										{t('pianoTunglyft.services.bohagsflytt.title')}
									</h3>
								</div>
								<p className="text-lg md:text-xl text-gray-100 mb-6 md:mb-8 relative">
									{t('pianoTunglyft.services.bohagsflytt.description')}
								</p>
								<p className="hidden md:block text-lg text-gray-100 mb-8 relative">
							...
							>
								...
								<div className="flex items-center gap-4 mb-6 md:mb-8 relative">
									<span className="text-4xl md:text-6xl">🏬</span>
									<h3 className="text-4xl md:text-5xl font-bold text-white">
										{t('pianoTunglyft.services.magasinering.title')}
									</h3>
								</div>
								<p className="text-lg md:text-xl text-gray-100 mb-1 md:mb-8 relative">
								{t('pianoTunglyft.services.magasinering.description')}
								</p>
								<p className="md:hidden text-lg text-gray-100 mb-6 md:mb-0 relative">
									{t('pianoTunglyft.services.magasinering.descriptionMobile')}
								</p>
								<p className="hidden md:block text-lg text-gray-100 mb-8 relative">
									{t('pianoTunglyft.services.magasinering.descriptionExtended')}
								</p>
								<div className="mt-auto relative">
									<motion.div 
										whileHover={{ scale: 1.05 }} 
					...
					<div className="container mx-auto px-4 relative z-10">
						<div className="max-w-3xl mx-auto text-center">
							<motion.h2 
								...
								id="upptack-tjanster"
							>
								{t('pianoTunglyft.services.allServices.title')}
							</motion.h2>
							<motion.p 
							...
							>
								{t('pianoTunglyft.services.allServices.description')}
							</motion.p>
							<motion.div
							...
							>
								...
								>
									...
									>
										{t('pianoTunglyft.services.allServices.movingServices')}
										<motion.svg 
											xmlns="http://www.w3.org/2000/svg" 
											className="h-5 w-5 ml-2 group-hover:translate-x-1 transition-transform" 
											fill="none" 
								...
								>
									<Link 
										...
										className="inline-flex items-center bg-gradient-to-r from-[#0F172A] to-[#10B981] text-white px-8 py-4 rounded-full hover:opacity-90 transition-opacity font-medium group"
									>
										{t('pianoTunglyft.services.allServices.cleaningServices')}
										<motion.svg 
											xmlns="http://www.w3.org/2000/svg" 
											className="h-5 w-5 ml-2 group-hover:translate-x-1 transition-transform" 
											fill="none" 
				...
				>
					...
					<div className="relative z-10 max-w-7xl mx-auto" style={{ marginTop: '-8rem' }}>
						<motion.div initial="initial" whileInView="animate" viewport={{ once: true }}>
							<h3 className="text-3xl md:text-4xl font-bold text-[#0F172A] mb-6 text-center">{t('pianoTunglyft.experience.title')}</h3>
							...
							<div className="mt-8 flex flex-col items-center justify-center gap-4">
								...
								<motion.div
									...
									transition={{ duration: 0.8 }}
								>
									<h4 className="text-3xl md:text-4xl font-bold text-[#0F172A] mb-4">{t('pianoTunglyft.experience.localExperienceTitle')}</h4>
									<p className="text-xl md:text-2xl text-[#0F172A] leading-relaxed mb-4 px-4 md:px-8">
										{t('pianoTunglyft.experience.localExperienceDesc1')}
									</p>
									{!showFullExperienceText && (
										<div className="md:hidden mb-3">
											...
											>
												{t('pianoTunglyft.experience.readMore')}
												<svg
													xmlns="http://www.w3.org/2000/svg"
									...
									{showFullExperienceText && (
										...
										>
											<p className="text-xl md:text-2xl text-[#0F172A] leading-relaxed">
												{t('pianoTunglyft.experience.localExperienceDesc2')}
											</p>
										</motion.div>
									)}
							...
							<div className="w-full">
								...
								<div className="text-center mb-6 md:mb-8 hidden md:block">
									<p className="text-white text-base md:text-lg lg:text-xl max-w-4xl mx-auto mb-4 md:mb-6 leading-relaxed">
										{t('pianoTunglyft.process.description')}
									</p>
								</div>
								...
								<div className="text-center mb-4 md:mb-8">
									<p className="text-white text-base md:text-lg lg:text-xl max-w-4xl mx-auto mb-3 md:mb-4">
										{t('pianoTunglyft.process.pricingDescription')}
									</p>
								</div>

								{/* Process Flow Section */}
								<div className="mb-4 md:mb-8">
									<h3 className="text-xl md:text-2xl lg:text-3xl font-bold text-white mb-4 md:mb-8 text-center">{t('pianoTunglyft.process.howItWorks')}</h3>
									<div className="relative w-full">
										...
										<div className="grid grid-cols-2 md:grid-cols-6 gap-1 md:gap-3 w-full items-stretch">
											{[
												{
													icon: <FillFormLottie />,
													title: t('pianoTunglyft.process.steps.0.title'),
													description: t('pianoTunglyft.process.steps.0.description'),
													textClass: ""
												},
												{
													icon: <FastLottie />,
													title: t('pianoTunglyft.process.steps.1.title'),
													description: t('pianoTunglyft.process.steps.1.description'),
													textClass: ""
												},
												{
													icon: <div className="ml-4 md:ml-6"><SignFormLottie /></div>,
													title: t('pianoTunglyft.process.steps.2.title'),
													description: t('pianoTunglyft.process.steps.2.description'),
													containerClass: "md:-mt-6",
													textClass: ""
												},
												{
													icon: <div className="md:ml-3 md:mt-8"><PhoneCallLottie /></div>,
													title: t('pianoTunglyft.process.steps.3.title'),
													description: t('pianoTunglyft.process.steps.3.description'),
													containerClass: "md:-mt-7",
													textClass: ""
												},
												{
													icon: <div className="md:mr-3"><MovingTruckLottie /></div>,
													title: t('pianoTunglyft.process.steps.4.title'),
													description: t('pianoTunglyft.process.steps.4.description'),
													containerClass: "md:-mt-14",
													textClass: "md:-mt-8",
												},
												{
													icon: <div className="md:mt-0"><HappyCustomerLottie /></div>,
													title: t('pianoTunglyft.process.steps.5.title'),
													description: t('pianoTunglyft.process.steps.5.description'),
													containerClass: "md:-mt-6",
													textClass: ""
												}
											].map((step, index) => (
				...
				<section className="py-8 md:py-16 bg-gray-50">
					<div className="w-full px-4 md:px-6">
						<div className="w-full">
							<div className="text-center mb-8 md:mb-12">
								<h2 className="text-2xl md:text-4xl font-bold text-[#0F172A] mb-3 md:mb-4">
									{t('pianoTunglyft.blog.title')}
								</h2>
								<p className="text-lg md:text-xl text-gray-600 max-w-2xl mx-auto px-4">
									{t('pianoTunglyft.blog.subtitle')}
								</p>
							</div>
							<div className="max-w-6xl mx-auto">
											...
											<div className="w-full md:w-2/3 p-4 md:p-6">
												<div className="flex flex-col sm:flex-row sm:items-center mb-3 md:mb-4 space-y-2 sm:space-y-0">
													<span className="bg-gradient-to-r from-[#0F172A] to-[#10B981] text-white px-3 py-1 md:px-4 md:py-2 rounded-full text-sm md:text-base font-medium w-fit">
														{t('pianoTunglyft.blog.category')}
													</span>
													<span className="text-gray-500 text-sm md:text-base sm:ml-4">{t('pianoTunglyft.blog.readTime')}</span>
												</div>
												<h3 className="text-xl md:text-3xl font-bold text-[#0F172A] mb-4 md:mb-6 leading-tight">
													{t('pianoTunglyft.blog.postTitle')}
												</h3>
												<p className="text-gray-600 text-base md:text-lg leading-relaxed mb-4 md:mb-6">
													{t('pianoTunglyft.blog.postDescription')}
												</p>
						...
						<div className="text-center mt-8 md:mb-12">
							...
							>
										{t('pianoTunglyft.blog.allArticles')}
								<svg 
									xmlns="http://www.w3.org/2000/svg" 
									className="h-4 w-4 md:h-5 md:w-5 ml-2 group-hover:translate-x-1 transition-transform" 
									fill="none" 
				...
				<section className="py-20 bg-white">
					...
					<div className="container mx-auto px-4">
						<div className="max-w-4xl mx-auto">
							<h2 className="text-3xl md:text-4xl font-bold text-[#0F172A] mb-12 text-center">
								{t('pianoTunglyft.faq.title')}
							</h2>
							<div className="space-y-4">
								{[
									{
										id: "piano-tunglyft-1",
										question: t('pianoTunglyft.faq.questions.0.question'),
										answer: t('pianoTunglyft.faq.questions.0.answer')
									},
									{
										id: "piano-tunglyft-2",
										question: t('pianoTunglyft.faq.questions.1.question'),
										answer: t('pianoTunglyft.faq.questions.1.answer')
									},
									{
										id: "piano-tunglyft-3",
										question: t('pianoTunglyft.faq.questions.2.question'),
										answer: t('pianoTunglyft.faq.questions.2.answer')
									},
									{
										id: "piano-tunglyft-4",
										question: t('pianoTunglyft.faq.questions.3.question'),
										answer: t('pianoTunglyft.faq.questions.3.answer')
									},
									{
										id: "piano-tunglyft-5",
										question: t('pianoTunglyft.faq.questions.4.question'),
										answer: t('pianoTunglyft.faq.questions.4.answer')
									}
								].map((faq, index) => (
									<motion.div
										key={faq.id}
					...
					<div className="text-center mt-12">
						<p className="text-lg text-gray-600 mb-6">
							{t('pianoTunglyft.faq.moreQuestions')}
						</p>
						<Link 
							href="/faq" 
							className="inline-flex items-center bg-gradient-to-r from-[#0F172A] to-[#10B981] text-white px-8 py-4 rounded-full hover:opacity-90 transition-opacity font-medium group"
						>
							{t('pianoTunglyft.faq.allFaq')}
							<svg 
								xmlns="http://www.w3.org/2000/svg" 
								className="h-5 w-5 ml-2 group-hover:translate-x-1 transition-transform" 
								fill="none" 
