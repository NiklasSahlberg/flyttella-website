...
export default function FlyttfirmaStockholmOsloPage() {
  return (
          ...
          <div className="max-w-4xl mx-auto">
            <div className="text-center mb-12">
              <h1 className="text-4xl md:text-6xl font-bold mb-6">
                Flyttfirma mellan Stockholm och Oslo
              </h1>
              <p className="text-xl md:text-2xl text-white/90 mb-8">
                Professionell flyttservice mellan Sverige och Norge. Med vår erfarenhet av internationella flyttar säkerställer vi en smidig och säker flyttprocess för ditt bohag.
              </p>
            </div>
      ...
      <div className="container mx-auto px-4 py-16">
        ...
        <div className="max-w-4xl mx-auto mb-16">
          <div className="bg-white rounded-xl shadow-lg p-8 md:p-12">
            <h2 className="text-2xl md:text-3xl font-bold text-[#0F172A] mb-6">
              Professionell flyttservice mellan Stockholm och Oslo
            </h2>
            <div className="space-y-4 text-gray-600">
              <p className="text-lg">
                Att flytta mellan Stockholm och Oslo är en internationell omställning som kräver noggrann planering och erfarenhet. 
              ...
              <p className="text-lg">
                Med vår erfarenhet av flyttar mellan Sverige och Norge kan vi hantera alla utmaningar som en internationell flytt innebär, 
        ...
        <div className="bg-gradient-to-r from-[#0F172A] to-[#10B981] rounded-lg shadow-lg p-8 text-white mb-16">
          <h2 className="text-2xl font-bold mb-6">
            Varför välja oss för din flytt mellan Stockholm och Oslo?
          </h2>
        ...
        <div className="text-center">
          <h2 className="text-3xl font-bold text-[#0F172A] mb-6">
            Boka din flytt mellan Stockholm och Oslo idag
          </h2>
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            "@type": "LocalBusiness",
            "name": "Flyttella - Flyttfirma mellan Stockholm och Oslo",
            "image": "https://flyttella.se/flyttella-logo.png",
            "description": "Professionell flyttfirma som erbjuder flyttservice mellan Stockholm och Oslo. Vi erbjuder komplett flyttservice inklusive packning, transport och upppackning.",
            "address": {
              "@type": "PostalAddress",
              "addressRegion": "Stockholm",
              "addressCountry": "SE"
            },
            "url": "https://flyttella.se/flyttfirma-i-stockholm-och-oslo",
